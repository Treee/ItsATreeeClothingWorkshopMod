...
class CfgVehicles
{
  ...
  class SRP_CombatHelmet_ColorBase;
  class SRP_CombatHelmetV2_ColorBase;
  class SRP_CombatHelmet6B47_ColorBase;
...
//=============================================== Vanilla Override
  ...
  class PrisonerCap_Brown: PrisonerCap
	...
	class NBCHood_Gray: NBCHoodBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class NBCHood_Yellow: NBCHoodBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
...
//============================================= CUSTOM Item Retextures
  class SRP_TurkeyBeanie_Turkey: SRP_TurkeyBeanie_ColorBase
	...
	class SRP_TurkeyBeanie_SkylarPink: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SRP_TurkeyBeanie_Green: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SRP_TurkeyBeanie_Grey: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SRP_TurkeyBeanie_Purple: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SRP_TurkeyBeanie_Teal: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SRP_TurkeyBeanie_Yellow: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SRP_TurkeyBeanie_Light: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SRP_TurkeyBeanie_Dark: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
	...
	class SRP_TurkeyBeanie_Snowflake: SRP_TurkeyBeanie_ColorBase
	{
		scope=2;
		hiddenSelectionsTextures[]=
		{
  ...
  class SRP_CombatHelmet_Black: SRP_CombatHelmet_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmet_Tan: SRP_CombatHelmet_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmet_Green: SRP_CombatHelmet_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
			"Survivalists_Retextures\characters\headgear\data\srp_combathelmet_co.paa"
		};
  };

  class SRP_CombatHelmetV2_Black: SRP_CombatHelmetV2_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmetV2_Tan: SRP_CombatHelmetV2_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmetV2_Green: SRP_CombatHelmetV2_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmet6B47_Tan: SRP_CombatHelmet6B47_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmet6B47_Green: SRP_CombatHelmet6B47_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmetHighCut_Tan: SRP_CombatHelmetHighCut_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmetHighCut_Green: SRP_CombatHelmetHighCut_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_AltynHelmetVisor_Black: SRP_AltynHelmetVisor_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmetAltyn_Tan: SRP_CombatHelmetAltyn_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_AltynHelmetVisor_Tan: SRP_AltynHelmetVisor_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
  ...
  class SRP_CombatHelmetAltyn_Green: SRP_CombatHelmetAltyn_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
			"Survivalists_Retextures\characters\headgear\data\srp_combathelmetaltyn_co.paa"
		};
  };
  class SRP_AltynHelmetVisor_Green: SRP_AltynHelmetVisor_ColorBase
  {
    scope=2;
		hiddenSelectionsTextures[] = 
		{
