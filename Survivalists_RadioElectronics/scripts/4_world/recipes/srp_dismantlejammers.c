class SRP_DismantleElectronicJammers extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle";
    ...
    SRP_RadioElectronics_KitBase.Cast( GetGame().CreateObjectEx(ingredients[0].GetType()+"_Kit", player.GetPosition(), false) );
	}
};