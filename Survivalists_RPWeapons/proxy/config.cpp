...
class CfgSlots
{
    ...
    class Slot_SRP_Norguldar
    {
        name = "SRP_NorguldarSword";
        displayName = "Norguldar Sword";
        ghostIcon = "set:dayz_inventory image:missing";
    };
    class Slot_SRP_NorguldarSheath
    {
        name = "SRP_NorguldarSheath";
        displayName = "Norguldar Sword Sheath";
        ghostIcon = "set:dayz_inventory image:missing";
    };
...
class CfgNonAIVehicles
{
    ...
    class Proxysrp_norguldar_proxy : ProxyAttachment //same as p3d name
    {
        scope = 2;
        inventorySlot[] = { "SRP_NorguldarSword" }; // same as slot name
        model = "Survivalists_RPWeapons\proxy\srp_norguldar_proxy.p3d"; //proxy path
    };
    class Proxysrp_norguldarsheath_proxy : ProxyAttachment //same as p3d name
    {
        scope = 2;
        inventorySlot[] = { "SRP_NorguldarSwordSheath" }; // same as slot name
        model = "Survivalists_RPWeapons\proxy\srp_norguldarsheath_proxy.p3d"; //proxy path
    };
