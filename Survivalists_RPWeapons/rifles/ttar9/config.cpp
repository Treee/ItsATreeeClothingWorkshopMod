class CfgPatches
{
	class Survivalists_RPWeapons_Rifles_ttar9
	{
		units[]=
		{
			"ttar9"
...
class cfgWeapons
{
	...
	class ttar9: M4A1
	{
		scope=2;
		displayName="AR9";
		descriptionShort="Espen Industries. AR9 is a submachine gun based on the AR-15 platform. Modified to accept MP5 magazines. Chambered in 9x19mm. Inspected by Master Gunsmith: Turko";
		model="Survivalists_RPWeapons\rifles\ttar9\ttar9.p3d";
