class SRP_Recipe_CraftGunpowder_Simple extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Roadflare");//you can insert multiple ingredients this way
		InsertIngredient(0,"SRP_Dynamite_Stack");//you can insert multiple ingredients this way
    ...
    if (m_AdminLog)
    {
      m_AdminLog.DirectAdminLogPrint("Player Died To Explosion by Salvaging for gunpowder. Nat 20 roll");
    }
...
class SRP_Recipe_CraftGunpowder_Explosives extends RecipeBase
{
	override void Init()
	{
		...
		InsertIngredient(0,"RGD5Grenade");//you can insert multiple ingredients this way
		InsertIngredient(0,"M67Grenade");//you can insert multiple ingredients this way
		InsertIngredient(0,"FlashGrenade");//you can insert multiple ingredients this way
		InsertIngredient(0,"LandMineTrap");//you can insert multiple ingredients this way
