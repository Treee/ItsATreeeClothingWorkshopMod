...
class CfgVehicles
{
    ...
    class SRP_JawGreatsword_ColorBase : Inventory_Base
    {
        scope = 0;
        displayName = "Jawblade Greatsword";
        descriptionShort = "A bone crafted heavy sword.";
        model = "Survivalists_RPWeapons\melee\blade\srp_bonegreatsword.p3d";
        debug_ItemCategory = 2;
        rotationFlags = 12;
        weight = 4400;
        itemSize[] = { 1,7 };
        ...
        hiddenselectionsTextures[] =
        {
            "Survivalists_RPWeapons\melee\blade\data\srp_bonesword_co.paa",
            "Survivalists_RPWeapons\melee\blade\data\srp_bonesword_co.paa",
        };
        class InventorySlotsOffsets
        {
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.0,{"Survivalists_RPWeapons\melee\blade\data\srp_bonesword_bone.rvmat"}},
                        {0.69999999,{"Survivalists_RPWeapons\melee\blade\data\srp_bonesword_bone.rvmat"}},
                        {0.5,{"Survivalists_RPWeapons\melee\blade\data\srp_bonesword_bone_damage.rvmat"}},
                        {0.30000001,{"Survivalists_RPWeapons\melee\blade\data\srp_bonesword_bone_damage.rvmat"}},
                        {0.0,{"Survivalists_RPWeapons\melee\blade\data\srp_bonesword_bone_destruct.rvmat"}}
                    };
                };
            };
        };
    ...
    class SRP_JawGreatsword_Basic : SRP_JawGreatsword_ColorBase
    {
        scope = 2;
        hiddenSelections[] =
        {
    ...
    class SRP_JawGreatsword_obamamama2580 : SRP_JawGreatsword_ColorBase
    {
        scope = 2;
        hiddenSelections[] =
        {
