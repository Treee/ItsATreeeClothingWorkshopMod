...
class CfgVehicles
{
    ...
    class land_srp_smokesignal_green : HouseNoDestruct
    {
        scope = 1;
    ...
    class land_srp_smokesignal_purple : HouseNoDestruct
    {
        scope = 1;
        model = "\dz\weapons\explosives\smokegrenade.p3d";
        rotationFlags = 17;
    ...
    class land_srp_smokesignal_red : HouseNoDestruct
    {
        scope = 1;
        model = "\dz\weapons\explosives\smokegrenade.p3d";
        rotationFlags = 17;
    ...
    class land_srp_smokesignal_white : HouseNoDestruct
    {
        scope = 1;
        model = "\dz\weapons\explosives\smokegrenade.p3d";
        rotationFlags = 17;
    ...
    class land_srp_smokesignal_yellow : HouseNoDestruct
    {
        scope = 1;
        model = "\dz\weapons\explosives\smokegrenade.p3d";
        rotationFlags = 17;
    ...
    class land_srp_smokesignal_black : HouseNoDestruct
    {
        scope = 1;
        model = "\dz\weapons\explosives\smokegrenade.p3d";
        rotationFlags = 17;
    ...
    class land_srp_smokesignal_crash : HouseNoDestruct
    {
        scope = 1;
        model = "\dz\weapons\explosives\smokegrenade.p3d";
        rotationFlags = 17;
