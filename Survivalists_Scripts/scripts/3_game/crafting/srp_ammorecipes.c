class SRP_AmmoRecipes extends SRP_RecipeManager
{
    override void Init()
    {
        ...
        craftableItems.Insert(Register_WeaponRepairKit_Recipe());
        craftableItems.Insert(Register_Weapon_JunkShotgun_Recipe());
        craftableItems.Insert(Register_Weapon_Boomstick_Recipe());
        craftableItems.Insert(Register_Weapon_JunkAK_Recipe());
        craftableItems.Insert(Register_Weapon_PaintballGun_Recipe());
        craftableItems.Insert(Register_Weapon_TaterGun_Recipe());
        craftableItems.Insert(Register_Weapon_Magnum_Recipe());
    }
//===========================TEMPLATE
    ...
    //     craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_GunBarrel", SRP_COLOR.NONE, 1));
    //     craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_MainReceiver", SRP_COLOR.NONE, 1));
    //     craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_Trigger", SRP_COLOR.NONE, 1));

    //     craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_Hammer", SRP_COLOR.NONE, 1));
    //     craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_GunGrip", SRP_COLOR.NONE, 1));
    //     craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_GunButtStock", SRP_COLOR.NONE, 1));
...
//===========================weapon tools
    SRP_CraftableItem Register_WeaponRepairKit_Recipe()
    {
        SRP_CraftableItem craftableItem = new SRP_CraftableItem("SRP_WeaponRepairKit", "Weapon Repair Kit", 50);
    ...
    SRP_CraftableItem Register_Weapon_JunkShotgun_Recipe()
    {
        SRP_CraftableItem craftableItem = new SRP_CraftableItem("DUB_JunkShotgun", "Survivor Junk Shotgun", 1, 0.5);
        ...
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_Trigger", SRP_COLOR.SIMPLE, 1));

        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_Hammer", SRP_COLOR.SIMPLE, 1));
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_GunGrip", SRP_COLOR.WOOD, 1));
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_GunButtStock", SRP_COLOR.WOOD, 1));
    ...
    SRP_CraftableItem Register_Weapon_JunkAK_Recipe()
    {
        SRP_CraftableItem craftableItem = new SRP_CraftableItem("junkak", "Junker AKM", 1, 0.5);

        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_GunBarrel", SRP_COLOR.RIFLEDMEDIUM, 1));
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_MainReceiver", SRP_COLOR.AUTOMEDIUM, 1));
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_Trigger", SRP_COLOR.SIMPLE, 1));
    ...
    SRP_CraftableItem Register_Weapon_PaintballGun_Recipe()
    {
        SRP_CraftableItem craftableItem = new SRP_CraftableItem("DUB_PaintBallGun", "Paintball Gun", 1, 0.5);

        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_GunBarrel", SRP_COLOR.MEDIUM, 1));
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_MainReceiver", SRP_COLOR.SEMIMEDIUM, 1));
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_Trigger", SRP_COLOR.SIMPLE, 1));
    ...
    SRP_CraftableItem Register_Weapon_TaterGun_Recipe()
    {
        SRP_CraftableItem craftableItem = new SRP_CraftableItem("DUB_TaterGun", "Potato Cannon", 1, 0.5);

        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_GunBarrel", SRP_COLOR.RIFLEDLONG, 1));
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_MainReceiver", SRP_COLOR.SEMILARGE, 1));
        craftableItem.RegisterIngredient(new SRP_ItemRequirement("SRP_Trigger", SRP_COLOR.SIMPLE, 1));
