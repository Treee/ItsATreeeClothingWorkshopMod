class CraftHotdog extends RecipeBase
{
	override void Init()
	{
		m_Name = "Make Hotdog";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"srpBreadFlatDough");//you can insert multiple ingredients this way
		InsertIngredient(0,"srpBreadLoaf");//you can insert multiple ingredients this way
		...
		InsertIngredient(1,"srpSausage_Human");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("srpHotdog");//add results here
  ...
  override bool CanDo(ItemBase ingredients[], PlayerBase player)//final check for recipe's validity
    ...
    if (ingredients[0] && ingredients[1])
      ...
      Edible_Base sausage = Edible_Base.Cast( ingredients[1] );
      if (bread && sausage)
      {
        return (bread.IsFoodBaked() && (sausage.IsFoodBaked() || sausage.IsFoodDried() || sausage.IsFoodBoiled()));
      }
    }
    return false;
	}
