class Craft_SRP_DismantleRaft extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle Raft";
		...
		InsertIngredient(0,"FirefighterAxe");//you can insert multiple ingredients this way
		InsertIngredient(0,"WoodAxe");//you can insert multiple ingredients this way
		InsertIngredient(0,"Crowbar");//you can insert multiple ingredients this way
		...
		//ingredient 2
		//----------------------------------------------------------------------------------------------------------------------
		InsertIngredient(1,"Raft");//you can insert multiple ingredients this way
	...
	{
		Debug.Log("Craft_SRP_DismantleRaft: Recipe Do method called","recipes");
	}
};
