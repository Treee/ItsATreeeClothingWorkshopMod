class Craft_SRP_SleepingBag_Basic extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Sew Rough Sleeping Bag";
		...
		//result1
		AddResult("SRP_SleepingBag_Basic_Kit");//add results here
	...
	{
		Debug.Log("Craft_SRP_SleepingBag_Basic Recipe Do method called","recipes");
	}
};