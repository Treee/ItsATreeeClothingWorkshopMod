class SRP_Craft_AlcoholMash_Kit extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Brewers Mash Kit";
...
class SRP_Craft_AddToMashPot_Base extends RecipeBase
{
	override void Init()
	{
		m_Name = "Add To Mash Pot";
...
class SRP_Craft_AddToMashPot_Fruit extends SRP_Craft_AddToMashPot_Base
{
	override void Init()
	{
    super.Init();
