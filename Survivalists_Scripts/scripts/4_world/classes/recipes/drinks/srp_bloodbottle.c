class Craft_SRP_WaterBottle_Blood extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Fill Bottle";
		...
		m_MinQuantityIngredient[1] = 450;//-1 = disable check
		...
		//result1
		AddResult("WaterBottle_Blood");//add results here
	...
	{
		Debug.Log("Craft_SRP_WaterBottle_Blood Recipe Do method called","recipes");
	}
};
