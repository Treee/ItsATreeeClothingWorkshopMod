...
class SRP_Halloween_TradeCoinsStaff_Base extends RecipeBase  
{
	override void Init()
	{
		m_Name = "Exchange For Weapon Staff";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation
		m_AnimationLength = 1;		// animation length in relative time units
		m_Specialty = 0;			// softskills modifier. value > 0 for roughness, value < 0 for precision
  ...
  override bool CanDo(ItemBase ingredients[], PlayerBase player)
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)
	{
    Debug.Log("SRP_Halloween_TradeCoinsStaff_Base Do method called:"+m_Name,"recipes");
	}
};

class SRP_Halloween_TradeCoinsStaff_Fire extends SRP_Halloween_TradeCoinsStaff_Base  
{
	override void Init()
	{
    super.Init();
		m_Name = "Exchange For Weapon Staff - Fire";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation		
    		//result 1
    AddResult("ADM_Staff_Fire");	// recipe result
	}
};
class SRP_Halloween_TradeCoinsStaff_Ice extends SRP_Halloween_TradeCoinsStaff_Base  
{
	override void Init()
	{
    super.Init();
		m_Name = "Exchange For Weapon Staff - Ice";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation		
    		//result 1
    AddResult("ADM_Staff_Ice");	// recipe result
	}
};
class SRP_Halloween_TradeCoinsStaff_Curse extends SRP_Halloween_TradeCoinsStaff_Base  
{
	override void Init()
	{
    super.Init();
		m_Name = "Exchange For Weapon Staff - Curse";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation		
    		//result 1
    AddResult("ADM_Staff_Curse");	// recipe result
	}
};
class SRP_Halloween_TradeCoinsStaff_Healing extends SRP_Halloween_TradeCoinsStaff_Base  
{
	override void Init()
	{
    super.Init();
		m_Name = "Exchange For Weapon Staff - Healing";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation		
    		//result 1
    AddResult("ADM_Staff_Healing");	// recipe result
	}
};


class SRP_Halloween_TradeCoinsGrimoire_Base extends RecipeBase  
{
	override void Init()
	{
		m_Name = "Exchange For Weapon Grimoire";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation
		m_AnimationLength = 1;		// animation length in relative time units
		m_Specialty = 0;			// softskills modifier. value > 0 for roughness, value < 0 for precision
  ...
  override bool CanDo(ItemBase ingredients[], PlayerBase player)
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)
	{
    Debug.Log("SRP_Halloween_TradeCoinsGrimoire_Base Do method called:"+m_Name,"recipes");
	}
};

class SRP_Halloween_TradeCoinsGrimoire_Armageddon extends SRP_Halloween_TradeCoinsGrimoire_Base  
{
	override void Init()
	{
    super.Init();
		m_Name = "Exchange For Weapon Grimoire - Armageddon";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation		
    		//result 1
    AddResult("ADM_Grimoire_Armageddon");	// recipe result
	}
};
class SRP_Halloween_TradeCoinsGrimoire_Regeneration extends SRP_Halloween_TradeCoinsGrimoire_Base  
{
	override void Init()
	{
    super.Init();
		m_Name = "Exchange For Weapon Grimoire - Regeneration";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation		
    		//result 1
    AddResult("ADM_Grimoire_Regeneration");	// recipe result
	}
};
class SRP_Halloween_TradeCoinsGrimoire_Immolation extends SRP_Halloween_TradeCoinsGrimoire_Base  
{
	override void Init()
	{
    super.Init();
		m_Name = "Exchange For Weapon Grimoire - Immolation";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation		
    		//result 1
    AddResult("ADM_Grimoire_Immolation");	// recipe result
	}
};
class SRP_Halloween_TradeCoinsGrimoire_Pestilence extends SRP_Halloween_TradeCoinsGrimoire_Base  
{
	override void Init()
	{
    super.Init();
		m_Name = "Exchange For Weapon Grimoire - Pestilence";	// action name in game
		m_IsInstaRecipe = false;	// should this recipe be performed instantly without animation		
    		//result 1
    AddResult("ADM_Grimoire_Pestilence");	// recipe result
	}
};
