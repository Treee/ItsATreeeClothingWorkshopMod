...
class SRP_Craft_SRP_MetalBarrelKit_Kit extends RecipeBase
{	
	override void Init()
	{
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("SRP_Craft_SRP_MetalBarrelKit_KitBase: Recipe Do method called: " + m_Name,"recipes");
	}
};

class SRP_Craft_SRP_MetalBarrelKit_OptionsBase extends RecipeBase
{	
  ...
  int m_RequiredMetalSheets;
	...
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SRP_MetalBarrelKit_Kit");//you can insert multiple ingredients this way
  ...
  override bool CanDo(ItemBase ingredients[], PlayerBase player)
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("SRP_Craft_SRP_MetalBarrelKit_OptionsBase: Recipe Do method called: " + m_Name,"recipes");
	}
};

class SRP_Craft_MetalBarrelOld extends SRP_Craft_SRP_MetalBarrelKit_OptionsBase
{	
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 10;
		m_Name = "Craft Metal Barrel Kit - Old";
		AddResult("SRP_MetalBarrel_Old_Kit");//add results here
	}
};
class SRP_Craft_MetalBarrelBlue extends SRP_Craft_SRP_MetalBarrelKit_OptionsBase
{	
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 15;
		m_Name = "Craft Metal Barrel Kit - Ammo Cache";
		AddResult("SRP_MetalBarrel_Blue_Kit");//add results here
	}
};
class SRP_Craft_MetalBarrelRed extends SRP_Craft_SRP_MetalBarrelKit_OptionsBase
{	
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 5;
		m_Name = "Craft Metal Barrel Kit - Medical Cache";
		AddResult("SRP_MetalBarrel_Red_Kit");//add results here
	}
};
class SRP_Craft_MetalBarrelYellow extends SRP_Craft_SRP_MetalBarrelKit_OptionsBase
{	
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 20;
		m_Name = "Craft Metal Barrel Kit - Irradiated Cache";
		AddResult("SRP_MetalBarrel_Yellow_Kit");//add results here
	}
};
class SRP_Craft_MetalBarrelConcrete extends SRP_Craft_SRP_MetalBarrelKit_OptionsBase
{	
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 20;
		m_Name = "Craft Metal Barrel Kit - Concrete Mixer";
		AddResult("SRP_MetalBarrel_Concrete_Kit");//add results here
	}
};


class SRP_Craft_MetalGunWallFence extends RecipeBase
{	
	override void Init()
	{
		...
		//result1
		AddResult("SRP_GunWall_Fence_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("SRP_Craft_MetalGunWallFence: Recipe Do method called","recipes");
	}
};

class SRP_Craft_MetalMeleeWallFence extends RecipeBase
{	
	override void Init()
	{
		...
		//result1
		AddResult("SRP_MeleeWall_Fence_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("SRP_Craft_MetalMeleeWallFence: Recipe Do method called","recipes");
	}
};

class SRP_Craft_Anvil extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Anvil";
		...
		//result1
		AddResult("SRP_Anvil_Basic_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("SRP_Craft_Anvil: Recipe Do method called","recipes");
	}
};