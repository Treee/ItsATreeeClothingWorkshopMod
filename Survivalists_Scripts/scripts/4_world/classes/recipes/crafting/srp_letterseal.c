class Craft_SRP_WoodenLetterSealer extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Letter Seal";
		...
		//result1
		AddResult("SRP_SealPress_NoWax");//add results here
	...
	{
		Debug.Log("Craft_SRP_WoodenLetterSealer: Recipe Do method called","recipes");
	}
};