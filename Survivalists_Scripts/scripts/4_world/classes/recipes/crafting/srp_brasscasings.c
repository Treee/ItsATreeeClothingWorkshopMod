// class SRP_CraftBrassCasings_Base extends RecipeBase  
// {
// 	override void Init()
// 	{
// 		m_Name = "Shave Into Casing";	// action name in game
...
// 		//ingredient 2					
// 		InsertIngredient(1,"SRP_ForgeIngotRod_Brass");
...
// 	{
//     Debug.Log("SRP_CraftBrassCasings_Base: Recipe Do method called","recipes");
// 	}
// };