class Craft_Msp_EmptyPlanterBox extends RecipeBase
{
	override void Init()
	{
		...
		//result1
		AddResult("Msp_EmptyPlanterBox");//add results here
	...
	{
		Debug.Log("Craft_Msp_EmptyPlanterBox Recipe Do method called","recipes");
	}
};

class Craft_Msp_EmptySquarePlanterBox extends RecipeBase
{
	override void Init()
	{
		...
		//result1
		AddResult("Msp_EmptySquarePlanterBox");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_Msp_EmptySquarePlanterBox Recipe Do method called","recipes");
	}
};