class Craft_SRP_StreetLightKit extends RecipeBase
{	
	override void Init()
	{
	...
	{
		Debug.Log("Craft_SRP_StreetLightKit: Recipe Do method called","recipes");
	}
};

class Craft_SRP_StreetLightSlim_Kit extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SRP_StreetLightKit_Kit");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"HeadlightH7");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_StreetLightSlim_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_StreetLightSlim_Kit: Recipe Do method called","recipes");
	}
};
...
class Craft_SRP_StreetLightLarge_Metal_Kit extends RecipeBase
{
	override void Init()
	{
		...
		//result1
		AddResult("SRP_StreetLightLarge_Metal_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_StreetLightLarge_Metal_Kit: Recipe Do method called","recipes");
	}
};
...
class Craft_SRP_StreetLightMedium_Wood_Kit extends RecipeBase
{
	override void Init()
	{
		...
		//result1
		AddResult("SRP_StreetLightMedium_Wood_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_StreetLightMedium_Wood_Kit: Recipe Do method called","recipes");
	}
};
