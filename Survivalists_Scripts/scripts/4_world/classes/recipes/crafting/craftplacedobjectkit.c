...
class Craft_SRP_ShootingTargets_Kit extends RecipeBase
{	
	override void Init()
	{
		...
		//result1
		AddResult("SRP_ShootingTargets_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_ShootingTargets_Kit: Recipe Do method called","recipes");
	}
};

class Craft_SRP_PortableGasLamp extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft Portable Gas Lamp";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SparkPlug");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SRP_CraftingMaterial_MetalScraps_Cut");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_PortableGasLamp");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_PortableGasLamp: Recipe Do method called","recipes");
	}
};
