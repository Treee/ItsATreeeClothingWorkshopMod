class SRP_Craft_AmmoCasing_Crude extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SRP_ForgeIngotPlate_Brass");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_Coinage_BrassBlank");//add results here
	...
	{
    m_ResultSetQuantity[0] = Math.RandomIntInclusive(1,7);
		return true;
	}

	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("SRP_Craft_AmmoCasing_Crude Do method called","recipes");
	}
};
class SRP_Craft_AmmoCasing_Advanced extends RecipeBase
{
	override void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"SRP_AdvancedWorkbench");//you can insert multiple ingredients this way		
	...
	override bool CanDo(ItemBase ingredients[], PlayerBase player)//final check for recipe's validity
	{
    m_ResultSetQuantity[0] = Math.RandomIntInclusive(3,6);
		return true;
	}

	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("SRP_Craft_AmmoCasing_Advanced Do method called","recipes");
	}
};