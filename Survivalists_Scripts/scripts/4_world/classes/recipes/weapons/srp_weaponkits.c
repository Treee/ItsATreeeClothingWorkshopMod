modded class CleanWeapon
{
	...
	{
        super.Init();
		InsertIngredient(0,"SRP_WeaponRepairKit"); //you can insert multiple ingredients this way
	}
};

class SRP_Craft_CleanWeapon extends RecipeBase
{
	override void Init()
	{
		m_Name = "Clean Weapon";
	...
	{
        Weapon_Base weapon;
        if (ingredients[1] && Class.CastTo(weapon, ingredients[1]))
        {
