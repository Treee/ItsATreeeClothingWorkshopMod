modded class MiscGameplayFunctions
{
    ...
    static TStringArray GetBookList()
    {
        ...
        "SRP_ReadableBook_Bible",
        "SRP_ReadableBook_TheWarOfTheWorlds",
        "SRP_ReadableBook_AroundTheWorldIn80Days",
        "SRP_ReadableBook_CrimeAndPunishment",
        "SRP_ReadableBook_TheMetamorphosis",
        "SRP_ReadableBook_TheRaven",
        "SRP_ReadableBook_TheArtOfWar",
        "SRP_ReadableBook_RobinsonCrusoe",
        "SRP_ReadableBook_Russian",
        "SRP_ReadableBook_RussianCheatSheet",
        "SRP_ReadableBook_ThePictureOfDorianGray",
        "SRP_ReadableBook_ThePitAndThePendulum",
        "SRP_ReadableBook_TheTimeMachine",
        "SRP_ReadableBook_TheCountryOfTheBlind",
        "SRP_ReadableBook_BilaNemoc",
        "SRP_ReadableBook_Youth",
        "SRP_ReadableBook_Verwandlung",
        "SRP_ReadableBook_TheJungleBook",
        "SRP_ReadableBook_TheBrothersKaramazov",
        "SRP_ReadableBook_TheCallOfCthulhu",
        "SRP_ReadableBook_TheShunnedHouse",
        "SRP_ReadableBook_TheHoundOfTheBaskervilles",
        "SRP_ReadableBook_TonyAndTheBeetles",
        "SRP_ReadableBook_TheCosmicComputer",
        "SRP_ReadableBook_ATravelerInTime",
        "SRP_ReadableBook_TheVariableMan",
        "SRP_ReadableBook_TheOutlet",
        "SRP_ReadableBook_TheBarrier",
        "SRP_ReadableBook_TheDesertOfWheat",
        "SRP_ReadableBook_FlyingURanch",
        "SRP_ReadableBook_CassidysRustlerRoundUp",
        "SRP_ReadableBook_LonesomeLand",
        "SRP_ReadableBook_Trailin",
        "SRP_ReadableBook_RonickyDoone",
        "SRP_ReadableBook_BettyZane",
        "SRP_ReadableBook_ATexasMatchmaker",
        "SRP_ReadableBook_TheThunderBird",
        "SRP_ReadableBook_BlackJack",
        "SRP_ReadableBook_TheLastTrail",
        "SRP_ReadableBook_SelectedStories",
        "SRP_ReadableBook_TheHeritageOfTheSioux",
        "SRP_ReadableBook_DesertGold",
        "SRP_ReadableBook_TheHiddenChildren",
        "SRP_ReadableBook_TheLastOfThePlainsmen",
        "SRP_ReadableBook_GunmansReckoning",
        "SRP_ReadableBook_Skyrider",
        "SRP_ReadableBook_SpinifexAndSand",
        "SRP_ReadableBook_SunsetPass",
        "SRP_ReadableBook_TheCaveOfGold",
        "SRP_ReadableBook_TheDayOfTheBeast",
        "SRP_ReadableBook_TheQuirt",
        "SRP_ReadableBook_AVoyageToArcturus",
        "SRP_ReadableBook_WealthOfNations",
        "SRP_ReadableBook_AndersensFairyTales",
        "SRP_ReadableBook_BlackBeauty",
        "SRP_ReadableBook_Buddenbrooks",
        "SRP_ReadableBook_DeadSouls",
        "SRP_ReadableBook_Erewhon",
        "SRP_ReadableBook_FatherGoriot",
        "SRP_ReadableBook_GreatExpectations",
        "SRP_ReadableBook_GulliversTravels",
        "SRP_ReadableBook_HeartOfDarkness",
        "SRP_ReadableBook_Herland",
        "SRP_ReadableBook_Ivanhoe",
        "SRP_ReadableBook_Kidnapped",
        "SRP_ReadableBook_LaChartreuseDeParme",
        "SRP_ReadableBook_LordJim",
        "SRP_ReadableBook_MadameBovary",
        "SRP_ReadableBook_Nostromo",
        "SRP_ReadableBook_NaturalSelection",
        "SRP_ReadableBook_TheMetamorphosesOfOvid",
        "SRP_ReadableBook_MobyDick",
        "SRP_ReadableBook_KingLear",
        "SRP_ReadableBook_LaDbcle",
        "SRP_ReadableBook_TheCanterburyTales",
        "SRP_ReadableBook_TheRightsOfWoman",
        "SRP_ReadableBook_ToTheInteriorOfTheEarth",
        "SRP_ReadableBook_NjalsSaga",
        "SRP_ReadableBook_TheTrial",
        "SRP_ReadableBook_DonQuixote",
        "SRP_ReadableBook_PhilosophiaeNaturalis",
        "SRP_ReadableBook_PrideAndPrejudice",
        "SRP_ReadableBook_Rasselas",
        "SRP_ReadableBook_Scaramouche",
        "SRP_ReadableBook_SonsAndLovers",
        "SRP_ReadableBook_TheCallOfTheWild",
        "SRP_ReadableBook_TheComingRace",
        "SRP_ReadableBook_TheIslandOfDoctorMoreau",
        "SRP_ReadableBook_TheMahabharataOfKrishna",
        "SRP_ReadableBook_TheManWhoWasThursday",
        "SRP_ReadableBook_ThePossessed",
        "SRP_ReadableBook_ThePrisonerOfZenda",
        "SRP_ReadableBook_APrincessOfMars",
        "SRP_ReadableBook_KingSolomonsMines",
        "SRP_ReadableBook_Middlemarch",
        "SRP_ReadableBook_TheHouseOfTheSevenGables",
        "SRP_ReadableBook_TheMonkARomance",
        "SRP_ReadableBook_TheJustifiedSinner",
        "SRP_ReadableBook_TheRedBadgeOfCourage",
        "SRP_ReadableBook_ADollsHouse",
        "SRP_ReadableBook_GilgameshEpic",
        "SRP_ReadableBook_AnnaKarenina",
        "SRP_ReadableBook_Candide",
        "SRP_ReadableBook_Faust",
        "SRP_ReadableBook_HinduLiterature",
        "SRP_ReadableBook_Hunger",
        "SRP_ReadableBook_JapaneseLiterature",
        "SRP_ReadableBook_LeRougeEtLeNoir",
        "SRP_ReadableBook_TheDecameron",
        "SRP_ReadableBook_TheGiacomoLeopardi",
        "SRP_ReadableBook_AliceInWonderland",
        "SRP_ReadableBook_TheScarletPimpernel",
        "SRP_ReadableBook_TheThreeMusketeers",
        "SRP_ReadableBook_TheTurnOfTheScrew",
        "SRP_ReadableBook_TranslationsOfShakuntala",
        "SRP_ReadableBook_TreasureIsland",
        "SRP_ReadableBook_Ulysses",
        "SRP_ReadableBook_UncleSilas",
        "SRP_ReadableBook_TheAeneid",
        "SRP_ReadableBook_WarAndPeace",
        "SRP_ReadableBook_WielandOrTheTransformation",
        "SRP_ReadableBook_WutheringHeights",
        "SRP_ReadableBook_CinqSemainesEnBallon",
        "SRP_ReadableBook_Dracula",
        "SRP_ReadableBook_DasNibelungenlied",
        "SRP_ReadableBook_TheLastMan",
        "SRP_ReadableBook_RomeoUndJulia",
        "SRP_ReadableBook_Frankenstein",
        "SRP_ReadableBook_DeLaTerreLaLune",
        "SRP_ReadableBook_LleMystrieuse",
        "SRP_ReadableBook_LaComdieHumaine",
        "SRP_ReadableBook_LesCorneilles",
        "SRP_ReadableBook_20000LieuesSousLesMers",
        "SRP_ReadableBook_ThreeMenInABoat",
        };
    }
