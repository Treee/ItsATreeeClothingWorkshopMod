modded class PlayerBase
{
    ...
    override void Init()
    {
        ...
        CrashSoundSets.RegisterSoundSet("SRP_Door_DoorKnock1_SoundSet1");
        CrashSoundSets.RegisterSoundSet("SRP_Door_DoorKnock2_SoundSet1");
    ...
    override void SetActions(out TInputActionMap InputActionMap)
    {
        ...
        AddAction(SRP_ActionKnockOnDoor, InputActionMap);
