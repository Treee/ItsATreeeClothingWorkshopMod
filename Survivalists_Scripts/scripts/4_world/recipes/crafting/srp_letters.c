class Craft_SRP_WoodenSignKit_Base extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Carved Symbol Kit";
	...
	{
		Debug.Log("Craft_SRP_WoodenSignKit_Base: Recipe Do method called: " + m_Name,"recipes");
	}
};