class Craft_SRP_WoodenFurnitureKit extends RecipeBase
{	
	override void Init()
	{
	...
	{
		Debug.Log("Craft_SRP_WoodenFurnitureKit: Recipe Do method called","recipes");
	}
};
...
class Craft_SRP_WoodenFurnitureKit_OptionsBase extends RecipeBase
{
  ...
  override bool CanDo(ItemBase ingredients[], PlayerBase player)
	{
    SRP_WoodenFurnitureKit_Kit kit;
...
class Craft_SRP_Furniture_WoodenTable_Kit extends Craft_SRP_WoodenFurnitureKit_OptionsBase
{
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 5;
		...
		m_Name = "Create Wooden Furniture Kit - Wooden Table";
		AddResult("SRP_Furniture_WoodenTable_Kit");//add results here
	}
};

class Craft_SRP_Furniture_Barrel_Kit extends Craft_SRP_WoodenFurnitureKit_OptionsBase
{
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 5;
		...
		m_Name = "Create Wooden Furniture Kit - Barrel";
		AddResult("SRP_Furniture_Barrel_Kit");//add results here
	}
};

class Craft_SRP_Furniture_BarrelTable_Kit extends Craft_SRP_WoodenFurnitureKit_OptionsBase
{
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 5;
		...
		m_Name = "Create Wooden Furniture Kit - Barrel Table";
		AddResult("SRP_Furniture_BarrelTable_Kit");//add results here
	}
};
...
class Craft_SRP_Furniture_Sofa_Modern_Kit extends RecipeBase
{
	override void Init()
	{
		...
		m_MinQuantityIngredient[1] = 8;//-1 = disable check
		m_MaxQuantityIngredient[1] = -1;//-1 = disable check
		//----------------------------------------------------------------------------------------------------------------------
		
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SRP_WoodenFurnitureKit_Kit");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"TannedLeather");//you can insert multiple ingredients this way
		
		m_IngredientAddHealth[1] = 0;// 0 = do nothing
		m_IngredientSetHealth[1] = -1; // -1 = do nothing
		m_IngredientAddQuantity[1] = -8;// 0 = do nothing
		m_IngredientDestroy[1] = false;// false = do nothing
		m_IngredientUseSoftSkills[1] = false;// set 'true' to allow modification of the values by softskills on this ingredient
		//----------------------------------------------------------------------------------------------------------------------
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_Furniture_Sofa_Modern_Kit: Recipe Do method called","recipes");
	}
};
class Craft_SRP_Furniture_Sofa_Old_Kit extends RecipeBase
{
	override void Init()
	{
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_Furniture_Sofa_Old_Kit: Recipe Do method called","recipes");
	}
};
class Craft_SRP_Furniture_LogStump extends RecipeBase
{
	override void Init()
	{
		...
		//result1
		AddResult("SRP_Furniture_LogStump");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_Furniture_LogStump: Recipe Do method called","recipes");
	}
};

class Craft_SRP_Furniture_LogBenchSmall extends Craft_SRP_WoodenFurnitureKit_OptionsBase
{
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 1;
		...
		m_Name = "Create Wooden Furniture Kit - Log Bench";
		AddResult("SRP_Furniture_LogBenchSmall");//add results here
	}
};

class Craft_SRP_Furniture_WoodBenchSmall extends Craft_SRP_WoodenFurnitureKit_OptionsBase
{
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 1;
		...
		m_Name = "Create Wooden Furniture Kit - Wood Bench";
		AddResult("SRP_Furniture_WoodBenchSmall");//add results here
	}
};

class Craft_SRP_Furniture_WoodBenchSlim extends Craft_SRP_WoodenFurnitureKit_OptionsBase
{
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 1;
		...
		m_Name = "Create Wooden Furniture Kit - Wood Bench Slim";
		AddResult("SRP_Furniture_WoodBenchSlim");//add results here
	}
};

class Craft_SRP_WoodenBench_Kit extends Craft_SRP_WoodenFurnitureKit_OptionsBase
{
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 10;
		...
		m_Name = "Create Wooden Furniture Kit - Picnic Bench";
		AddResult("SRP_WoodenBench_Kit");//add results here
	}
};

class Craft_SRP_Furniture_PileOfPlanks extends RecipeBase
{
	override void Init()
	{
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_Furniture_PileOfPlanks: Recipe Do method called","recipes");
	}
};
class Craft_SRP_Furniture_SmallLogPile extends RecipeBase
{
	override void Init()
	{
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_Furniture_SmallLogPile: Recipe Do method called","recipes");
	}
};
class Craft_SRP_Furniture_LargeLogPile extends RecipeBase
{
	override void Init()
	{
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_Furniture_LargeLogPile: Recipe Do method called","recipes");
	}
};
...
class Craft_SRP_Gazebo_Kit extends Craft_SRP_WoodenFurnitureKit_OptionsBase
{
	override void Init()
	{
    super.Init();
    ...
    m_RequiredMetalSheets = 10;
		...
		m_Name = "Create Wooden Furniture Kit - Gazebo";
		AddResult("SRP_Furniture_Gazebo_Kit");//add results here
	}
};
