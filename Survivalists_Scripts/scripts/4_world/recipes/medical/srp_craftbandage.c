class Craft_SRP_BandageDressing extends RecipeBase
{
	override void Init()
	{
		m_Name = "Make Crude Bandage";
		...
		m_MaxDamageIngredient[1] = 0;//-1 = disable check
		...
		//result1
		AddResult("BandageDressing");//add results here
	...
	{
		Debug.Log("Craft_SRP_BandageDressing Recipe Do method called","recipes");
	}
};