class SRP_Craft_RiceCrispy extends RecipeBase
{
	override void Init()
	{
		m_Name = "Make Rice Crispy";
		...
		//ingredient 2
		InsertIngredient(1,"Honey_Marshmellow");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Zagorky_RiceCrispy");//add results here
