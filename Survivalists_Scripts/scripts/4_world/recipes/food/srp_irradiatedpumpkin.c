class CutOutPumpkinSeeds_Irradiated extends CutOutSeeds
{	
	override void Init()
	{
		m_Name = "#STR_prepare0";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Pumpkin_Irradiated");//you can insert multiple ingredients this way
		...
		//result2
		AddResult("SlicedPumpkin_Irradiated");//add results here
	...
	{		
		...
		ItemBase slice1 = results[0];	
		ItemBase slice2 = results[1];
