class Craft_SRP_AccessoryRing_StarterKit extends RecipeBase
{
	override void Init()
	{
		m_Name = "Create Ring Kit - Starter";
		...
		//result1
		AddResult("SRP_AccessoryRing_Kit");//add results here
	...
	{
		Debug.Log("Craft_SRP_AccessoryRing_Recipe: Recipe Do method called: " + m_Name,"recipes");
	}
};