class CraftBreadDough extends RecipeBase
{
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"BoxCerealCrunchin_Flour");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"Honey_Yeast");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("srpBreadRoundDough");//add results here
...
class CraftBreadDough_Loaf extends RecipeBase
{
	override void Init()
	{
		...
		//result1
		AddResult("srpBreadLoaf");//add results here
...
class CraftBreadDough_Flatbread extends RecipeBase
{
	override void Init()
	{
		...
		//result1
		AddResult("srpBreadFlatDough");//add results here
