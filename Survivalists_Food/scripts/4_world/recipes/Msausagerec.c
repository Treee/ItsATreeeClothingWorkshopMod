class CraftMSausage extends RecipeBase
{
	override void Init()
	{
		m_Name = "Create Raw Sausage.";
		...
		//ingredient 2
		InsertIngredient(1,"Guts");//you can insert multiple ingredients this way
		InsertIngredient(1,"SmallGuts");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("srpSausage_Human");//add results here
