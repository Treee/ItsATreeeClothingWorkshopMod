...
{
	class Mosin9130;
	class BW_M24: Mosin9130
	{
		scope=2;
		displayName="M24";
		descriptionShort="The M24 is the military and police version of the Remington Model 700 rifle.";
		model="Bill_Mods\data\New_Guns\M24\BW_M24.p3d";
		attachments[]={"weaponOpticsHunting","weaponOptics","weaponWrap","weaponMuzzleM4"};
