...
//======================================= FISHING RODS
  ...
  class IAT_Fishing_WoodenRod_ColorBase: FishingRod_Base_New
	{
		...
		model="IAT\Core\IAT_Fishing\tools\iat_handmadefishingrod.p3d";
    ...
    hiddenSelections[]={"zbytek"};
		hiddenSelectionsTextures[]={"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod_co.paa"};
		hiddenSelectionsMaterials[]={"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"};
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{						
						{1.0,{"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"}},						
						{0.69999999,{"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"}},						
						{0.5,{"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"}},						
						{0.30000001,{"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"}},						
						{0.0,{"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"}}
					};
				};
			};
		};
  ...
  class IAT_Fishing_WoodenRod_Blue: IAT_Fishing_WoodenRod_ColorBase
    ...
    color="blue";
    hiddenSelections[]={"zbytek"};
		hiddenSelectionsTextures[]={"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod_blue_co.paa"};
		hiddenSelectionsMaterials[]={"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"};
	};
  class IAT_Fishing_WoodenRod_Purple: IAT_Fishing_WoodenRod_ColorBase
    ...
    color="purple";
    hiddenSelections[]={"zbytek"};
		hiddenSelectionsTextures[]={"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod_purple_co.paa"};
		hiddenSelectionsMaterials[]={"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"};
	};
  class IAT_Fishing_WoodenRod_Red: IAT_Fishing_WoodenRod_ColorBase
    ...
    color="red";
    hiddenSelections[]={"zbytek"};
		hiddenSelectionsTextures[]={"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod_red_co.paa"};
		hiddenSelectionsMaterials[]={"IAT\Core\IAT_Fishing\tools\data\iat_handmadefishingrod.rvmat"};
	};
//======================================= END
};