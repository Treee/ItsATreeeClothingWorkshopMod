class IAT_PrepareCustomFish extends PrepareFish
{	
  override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"IAT_Fishing_FreshWaterFish_Base");//you can insert multiple ingredients this way
		InsertIngredient(0,"IAT_Fishing_SaltWaterFish_Base");//you can insert multiple ingredients this way
