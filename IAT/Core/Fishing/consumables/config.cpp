class CfgPatches
{
    class IAT_Core_Fishing_Consumables
    {
        units[] = {};
        weapons[] = {};
        requiredVersion = 0.1;
...
class CfgVehicles
{
    ...
    class IAT_Fishing_Pearl_ColorBase : Inventory_Base
    {
        ...
        model = "IAT\Core\Fishing\consumables\iat_pearl.p3d";
        isMeleeWeapon = 1;
        weight = 2;
        absorbency = 0;
        itemSize[] = { 1,1 };
        ...
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_pearl_ca.paa" };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                      {1.0,	{	"IAT\Core\Fishing\consumables\data\iat_pearl.rvmat"}},
                      {0.69999999,	{	"IAT\Core\Fishing\consumables\data\iat_pearl.rvmat"}},
                      {0.5,	{	"IAT\Core\Fishing\consumables\data\iat_pearl.rvmat"}},
                      {0.30000001,	{	"IAT\Core\Fishing\consumables\data\iat_pearl.rvmat"}},
                      {0.0,	{	"IAT\Core\Fishing\consumables\data\iat_pearl.rvmat"}}
                    };
                };
            };
        };
    ...
    class IAT_Fishing_Pearl_Teal : IAT_Fishing_Pearl_ColorBase // rare
    {
        ...
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_pearl_teal_ca.paa" };
    };
    class IAT_Fishing_Pearl_Silver : IAT_Fishing_Pearl_ColorBase
    {
        ...
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_pearl_silver_ca.paa" };
    };
    class IAT_Fishing_Pearl_Rose : IAT_Fishing_Pearl_ColorBase
    {
        ...
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_pearl_rose_ca.paa" };
    };
    class IAT_Fishing_Pearl_Gold : IAT_Fishing_Pearl_ColorBase // rare
    {
        ...
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_pearl_gold_ca.paa" };
    };
    //======================================= CLAMS
    class IAT_Fishing_Clam_ColorBase : Inventory_Base
    {
        ...
        model = "IAT\Core\Fishing\consumables\iat_clam.p3d";
        ...
        {
            "IAT\Core\Fishing\consumables\data\iat_clam_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}},
            {0.69999999,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}},
            {0.5,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}},
            {0.30000001,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}},
            {0,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}}
                    };
                };
            };
        };
    ...
    class IAT_Fishing_Clam_ColorBase_Opened : Inventory_Base
    {
        ...
        model = "IAT\Core\Fishing\consumables\iat_clam_opened.p3d";
        debug_ItemCategory = 6;
        itemSize[] = { 2,1 };
        weight = 265;
        varQuantityInit = 0;
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.0,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}},
                        {0.0,{"IAT\Core\Fishing\consumables\data\iat_clam.rvmat"}}
                    };
                };
            };
        };
    ...
    class IAT_Fishing_Clam_Blue : IAT_Fishing_Clam_ColorBase
    {
        ...
        color = "blue";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_clam_blue_co.paa" };
    };
    ...
    class IAT_Fishing_Clam_Red : IAT_Fishing_Clam_ColorBase
    {
        ...
        color = "red";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_clam_red_co.paa" };
    };
    ...
    class IAT_Fishing_Clam_Silver : IAT_Fishing_Clam_ColorBase
    {
        ...
        color = "silver";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_clam_silver_co.paa" };
    };
    ...
    class IAT_Fishing_Lure_ColorBase : Inventory_Base
    {
        ...
        model = "IAT\Core\Fishing\consumables\iat_fishinglure1.p3d";
        rotationFlags = 64;
        weight = 1;
      ...
      "IAT_FishingLure13",
        ...
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\consumables\data\iat_fishinglures_ca.paa"
        };
        hiddenSelectionsMaterials[] =
        {
            "IAT\Core\Fishing\consumables\data\iat_fishinglures.rvmat"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.0,{"IAT\Core\Fishing\consumables\data\iat_fishinglures.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\consumables\data\iat_fishinglures.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\consumables\data\iat_fishinglures.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\consumables\data\iat_fishinglures.rvmat"}},
                        {0.0,{"IAT\Core\Fishing\consumables\data\iat_fishinglures.rvmat"}}
                    };
                };
            };
        };
    ...
    class IAT_Fishing_Lure_Metal1_ColorBase : IAT_Fishing_Lure_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\consumables\data\iat_fishinglures1_ca.paa"
        };
    };
    class IAT_Fishing_Lure_Metal2_ColorBase : IAT_Fishing_Lure_ColorBase
    {
        scope = 0;
        model = "IAT\Core\Fishing\consumables\iat_fishinglure2.p3d";
        hiddenSelections[] =
        {
            "zbytek"
        };
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\consumables\data\iat_fishinglures2_ca.paa"
        };
    };
    class IAT_Fishing_Lure_Metal3_ColorBase : IAT_Fishing_Lure_ColorBase
    {
        scope = 0;
        model = "IAT\Core\Fishing\consumables\iat_fishinglure3.p3d";
        hiddenSelections[] =
        {
            "zbytek"
        };
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\consumables\data\iat_fishinglures3_ca.paa"
        };
    };
    class IAT_Fishing_Lure_WoodenFish1_ColorBase : IAT_Fishing_Lure_ColorBase
    {
        scope = 0;
        model = "IAT\Core\Fishing\consumables\iat_fishinglurefish1.p3d";
        hiddenSelections[] =
        {
            "zbytek"
        };
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\consumables\data\iat_fishingluresfish1_ca.paa"
        };
    };
    class IAT_Fishing_Lure_WoodenFish2_ColorBase : IAT_Fishing_Lure_ColorBase
    {
        scope = 0;
        model = "IAT\Core\Fishing\consumables\iat_fishinglurefish2.p3d";
        hiddenSelections[] =
        {
            "zbytek"
        };
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\consumables\data\iat_fishingluresfish2_ca.paa"
        };
    };
    class IAT_Fishing_Lure_WoodenFish3_ColorBase : IAT_Fishing_Lure_ColorBase
    {
        scope = 0;
        model = "IAT\Core\Fishing\consumables\iat_fishinglurefish3.p3d";
        hiddenSelections[] =
        {
            "zbytek"
        };
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\consumables\data\iat_fishingluresfish3_ca.paa"
        };
    };
    // concrete
    class IAT_Fishing_Lure_Metal1_1 : IAT_Fishing_Lure_Metal1_ColorBase
    {
        ...
        color = "1";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_fishinglures_ca.paa" };
    };
    class IAT_Fishing_Lure_Metal1_2 : IAT_Fishing_Lure_Metal1_ColorBase
    {
        ...
        color = "1";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_fishinglures1_ca.paa" };
    };
    class IAT_Fishing_Lure_Metal1_3 : IAT_Fishing_Lure_Metal1_ColorBase
    {
        ...
        color = "1";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_fishinglures2_ca.paa" };
    };
    class IAT_Fishing_Lure_Metal1_4 : IAT_Fishing_Lure_Metal1_ColorBase
    {
        ...
        color = "1";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "IAT\Core\Fishing\consumables\data\iat_fishinglures3_ca.paa" };
    };
