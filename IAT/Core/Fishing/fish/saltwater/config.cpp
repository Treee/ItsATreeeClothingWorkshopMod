class CfgPatches
{
    class IAT_Core_Fishing_Fish_SaltWater
    {
        units[] = {};
        weapons[] = {};
        requiredVersion = 0.1;
...
class CfgVehicles
{
    ...
    class IAT_Fishing_CoralFish_ColorBase : IAT_Fishing_SaltWaterFish_Base
    {
        ...
        model = "IAT\Core\Fishing\fish\saltwater\iat_coralfish.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_coralfish_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1,{"IAT\Core\Fishing\fish\saltwater\data\iat_coralfish.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\saltwater\data\iat_coralfish.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\saltwater\data\iat_coralfish.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\saltwater\data\iat_coralfish.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\saltwater\data\iat_coralfish.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\coralfish.p3d";
        itemSize[] = { 1,2 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\coralfish_m.p3d";
        itemSize[] = { 2,2 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\coralfish_l.p3d";
        itemSize[] = { 2,3 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\coralfish_xl.p3d";
        itemSize[] = { 3,3 };
        weight = 1500;
    ...
    class IAT_Fishing_CoralFish_Green_Small : IAT_Fishing_CoralFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_coralfish_green_co.paa"
        };
    };
    ...
    class IAT_Fishing_CoralFish_Purple_Small : IAT_Fishing_CoralFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_coralfish_purple_co.paa"
        };
    };
    ...
    class IAT_Fishing_CoralFish_Red_Small : IAT_Fishing_CoralFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_coralfish_red_co.paa"
        };
    };
    ...
    class IAT_Fishing_CoralFish_Yellow_Small : IAT_Fishing_CoralFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_coralfish_yellow_co.paa"
        };
    };
    ...
    class IAT_Fishing_AngelFish_ColorBase : IAT_Fishing_SaltWaterFish_Base
    {
        ...
        descriptionShort = "A colorful fish found in salt water.";
        model = "IAT\Core\Fishing\fish\saltwater\iat_angelfish.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_angelfish_blue_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1,{"IAT\Core\Fishing\fish\saltwater\data\iat_angelfish.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\saltwater\data\iat_angelfish.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\saltwater\data\iat_angelfish.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\saltwater\data\iat_angelfish.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\saltwater\data\iat_angelfish.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\angelfish.p3d";
        itemSize[] = { 1,2 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\angelfish_m.p3d";
        itemSize[] = { 2,2 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\angelfish_l.p3d";
        itemSize[] = { 2,3 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\angelfish_xl.p3d";
        itemSize[] = { 3,3 };
        weight = 1500;
        varQuantityInit = 1500;
        varQuantityMax = 1500;
    ...
    class IAT_Fishing_AngelFish_Orange_Small : IAT_Fishing_AngelFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_angelfish_orange_co.paa"
        };
    };
    ...
    class IAT_Fishing_AngelFish_Red_Small : IAT_Fishing_AngelFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_angelfish_red_co.paa"
        };
    };
    ...
    class IAT_Fishing_AngelFish_Yellow_Small : IAT_Fishing_AngelFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_angelfish_yellow_co.paa"
        };
    };
    ...
    class IAT_Fishing_SailFish_ColorBase : IAT_Fishing_SaltWaterFish_Base
    {
        ...
        model = "IAT\Core\Fishing\fish\saltwater\iat_sailfish.p3d";
        hiddenSelections[] = { "zbytek" };
        rotationFlags = 4;
        inventorySlot[] =
        {
      ...
      "IAT_Fishing_Fish_Large1"
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_sailfish_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1,{"IAT\Core\Fishing\fish\saltwater\data\iat_sailfish.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\saltwater\data\iat_sailfish.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\saltwater\data\iat_sailfish.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\saltwater\data\iat_sailfish.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\saltwater\data\iat_sailfish.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\sailfish.p3d";
        itemSize[] = { 4,5 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\sailfish_m.p3d";
        itemSize[] = { 4,6 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\sailfish_l.p3d";
        itemSize[] = { 4,7 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\sailfish_xl.p3d";
        itemSize[] = { 5,8 };
        weight = 1500;
        varQuantityInit = 1500;
        varQuantityMax = 1500;
    ...
    class IAT_Fishing_SailFish_Green_Small : IAT_Fishing_SailFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_sailfish_green_co.paa"
        };
    };
    ...
    class IAT_Fishing_SailFish_Red_Small : IAT_Fishing_SailFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_sailfish_red_co.paa"
        };
    };
    ...
    class IAT_Fishing_SailFish_Yellow_Small : IAT_Fishing_SailFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_sailfish_yellow_co.paa"
        };
    };
    ...
    class IAT_Fishing_SailFish_Silver_Small : IAT_Fishing_SailFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_sailfish_silver_co.paa"
        };
    };
    ...
    class IAT_Fishing_AnglerFish_ColorBase : IAT_Fishing_SaltWaterFish_Base
    {
        ...
        model = "IAT\Core\Fishing\fish\saltwater\iat_anglerfish.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_anglerfish_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1,{"IAT\Core\Fishing\fish\saltwater\data\iat_anglerfish.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\saltwater\data\iat_anglerfish.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\saltwater\data\iat_anglerfish.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\saltwater\data\iat_anglerfish.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\saltwater\data\iat_anglerfish.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\anglerfish.p3d";
        itemSize[] = { 2,3 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\anglerfish_m.p3d";
        itemSize[] = { 3,3 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\anglerfish_l.p3d";
        itemSize[] = { 3,4 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\anglerfish_xl.p3d";
        itemSize[] = { 3,5 };
        weight = 1500;
        varQuantityInit = 1500;
        varQuantityMax = 1500;
    ...
    class IAT_Fishing_AnglerFish_Purple_Small : IAT_Fishing_AnglerFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_anglerfish_purple_co.paa"
        };
    };
    ...
    class IAT_Fishing_AnglerFish_Silver_Small : IAT_Fishing_AnglerFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_anglerfish_silver_co.paa"
        };
    };
    ...
    class IAT_Fishing_HammerHeadFish_ColorBase : IAT_Fishing_SaltWaterFish_Base
    {
        ...
        model = "IAT\Core\Fishing\fish\saltwater\iat_hammerheadshark.p3d";
        rotationFlags = 64;
        inventorySlot[] =
        {
            "TrapPrey_1",
      "IAT_Fishing_Fish_Large1"
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        ...
                        {1,{"IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\hammerheadshark.p3d";
        itemSize[] = { 4,5 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\hammerheadshark_m.p3d";
        itemSize[] = { 4,6 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\hammerheadshark_l.p3d";
        itemSize[] = { 5,6 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\saltwater\hammerheadshark_xl.p3d";
        itemSize[] = { 6,7 };
        weight = 1500;
        varQuantityInit = 1500;
        varQuantityMax = 1500;
    ...
    class IAT_Fishing_HammerHeadFish_Red_Small : IAT_Fishing_HammerHeadFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark_red_co.paa"
        };
    };
    ...
    class IAT_Fishing_HammerHeadFish_Silver_Small : IAT_Fishing_HammerHeadFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark_silver_co.paa"
        };
    };
    ...
    class IAT_Fishing_HammerHeadFish_Yellow_Small : IAT_Fishing_HammerHeadFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\saltwater\data\iat_hammerheadshark_yellow_co.paa"
        };
    };
