class CfgPatches
{
    class IAT_Core_Fishing_Fish_Freshwater
    {
        units[] = {};
        weapons[] = {};
        requiredVersion = 0.1;
...
class CfgVehicles
{
    ...
    class IAT_Fishing_TroutFish_ColorBase : IAT_Fishing_FreshWaterFish_Base
    {
        ...
        displayName = "Trout";
        descriptionShort = "A fish found in fresh water.";
        model = "IAT\Core\Fishing\fish\freshwater\iat_trout.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_trout_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        ...
                        {1,{"IAT\Core\Fishing\fish\freshwater\data\iat_trout.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\freshwater\data\iat_trout.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\freshwater\data\iat_trout.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\freshwater\data\iat_trout.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\freshwater\data\iat_trout.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\trout.p3d";
        itemSize[] = { 1,2 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\trout_m.p3d";
        itemSize[] = { 2,2 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\trout_l.p3d";
        itemSize[] = { 2,3 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\trout_xl.p3d";
        itemSize[] = { 3,3 };
        weight = 1500;
    ...
    class IAT_Fishing_TroutFish_Blue_Small : IAT_Fishing_TroutFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_trout_blue_co.paa"
        };
    };
    ...
    class IAT_Fishing_TroutFish_Red_Small : IAT_Fishing_TroutFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_trout_red_co.paa"
        };
    };
    ...
    class IAT_Fishing_TroutFish_Yellow_Small : IAT_Fishing_TroutFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_trout_yellow_co.paa"
        };
    };
    ...
    class IAT_Fishing_MutantFish_ColorBase : IAT_Fishing_FreshWaterFish_Base
    {
        ...
        model = "IAT\Core\Fishing\fish\freshwater\iat_mutantfish.p3d";
        hiddenSelections[] = { "zbytek" };
        rotationFlags = 64;
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1,{"IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\mutantfish.p3d";
        itemSize[] = { 1,2 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\mutantfish_m.p3d";
        itemSize[] = { 2,2 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\mutantfish_l.p3d";
        itemSize[] = { 2,3 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\mutantfish_xl.p3d";
        itemSize[] = { 3,3 };
        weight = 1500;
        varQuantityInit = 1500;
        varQuantityMax = 1500;
    ...
    class IAT_Fishing_MutantFish_Blue_Small : IAT_Fishing_MutantFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish_blue_co.paa"
        };
    };
    ...
    class IAT_Fishing_MutantFish_Green_Small : IAT_Fishing_MutantFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish_green_co.paa"
        };
    };
    ...
    class IAT_Fishing_MutantFish_Yellow_Small : IAT_Fishing_MutantFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_mutantfish_yellow_co.paa"
        };
    };
    ...
    class IAT_Fishing_SplakeFish_ColorBase : IAT_Fishing_FreshWaterFish_Base
    {
        ...
        model = "IAT\Core\Fishing\fish\freshwater\iat_splake.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_splake_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        ...
                        {1,{"IAT\Core\Fishing\fish\freshwater\data\iat_splake.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\freshwater\data\iat_splake.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\freshwater\data\iat_splake.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\freshwater\data\iat_splake.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\freshwater\data\iat_splake.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\splake.p3d";
        itemSize[] = { 1,2 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\splake_m.p3d";
        itemSize[] = { 2,2 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\splake_l.p3d";
        itemSize[] = { 2,3 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\splake_xl.p3d";
        itemSize[] = { 3,3 };
        weight = 1500;
        varQuantityInit = 1500;
        varQuantityMax = 1500;
    ...
    class IAT_Fishing_SplakeFish_Blue_Small : IAT_Fishing_SplakeFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_splake_blue_co.paa"
        };
    };
    ...
    class IAT_Fishing_SplakeFish_Green_Small : IAT_Fishing_SplakeFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_splake_green_co.paa"
        };
    };
    ...
    class IAT_Fishing_SplakeFish_Yellow_Small : IAT_Fishing_SplakeFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_splake_yellow_co.paa"
        };
    };
    ...
    class IAT_Fishing_SplakeFish_Purple_Small : IAT_Fishing_SplakeFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_splake_purple_co.paa"
        };
    };
    ...
    class IAT_Fishing_PerchFish_ColorBase : IAT_Fishing_FreshWaterFish_Base
    {
        ...
        displayName = "Perch";
        descriptionShort = "A fish found in fresh water.";
        model = "IAT\Core\Fishing\fish\freshwater\iat_perch.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_perch_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        ...
                        {1,{"IAT\Core\Fishing\fish\freshwater\data\iat_perch.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\freshwater\data\iat_perch.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\freshwater\data\iat_perch.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\freshwater\data\iat_perch.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\freshwater\data\iat_perch.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\perch.p3d";
        itemSize[] = { 1,2 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\perch_m.p3d";
        itemSize[] = { 2,2 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\perch_l.p3d";
        itemSize[] = { 2,3 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\perch_xl.p3d";
        itemSize[] = { 3,3 };
        weight = 1500;
        varQuantityInit = 1500;
        varQuantityMax = 1500;
    ...
    class IAT_Fishing_PerchFish_Blue_Small : IAT_Fishing_PerchFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_perch_blue_co.paa"
        };
    };
    ...
    class IAT_Fishing_PerchFish_Green_Small : IAT_Fishing_PerchFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_perch_green_co.paa"
        };
    };
    ...
    class IAT_Fishing_PerchFish_Yellow_Small : IAT_Fishing_PerchFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_perch_yellow_co.paa"
        };
    };
    ...
    class IAT_Fishing_PerchFish_Silver_Small : IAT_Fishing_PerchFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_perch_silver_co.paa"
        };
    };
    ...
    class IAT_Fishing_TilapiaFish_ColorBase : IAT_Fishing_FreshWaterFish_Base
    {
        ...
        displayName = "Tilapia";
        descriptionShort = "A fish found in fresh water.";
        model = "IAT\Core\Fishing\fish\freshwater\iat_tilapia.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_tilapia_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        ...
                        {1,{"IAT\Core\Fishing\fish\freshwater\data\iat_tilapia.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\fish\freshwater\data\iat_tilapia.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\fish\freshwater\data\iat_tilapia.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\fish\freshwater\data\iat_tilapia.rvmat"}},
                        {0,{"IAT\Core\Fishing\fish\freshwater\data\iat_tilapia.rvmat"}}
                    };
                };
            };
        };
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\tilapia.p3d";
        itemSize[] = { 1,2 };
        weight = 250;
        varQuantityInit = 500;
        varQuantityMax = 500;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\tilapia_m.p3d";
        itemSize[] = { 2,2 };
        weight = 500;
        varQuantityInit = 750;
        varQuantityMax = 750;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\tilapia_l.p3d";
        itemSize[] = { 2,3 };
        weight = 750;
        varQuantityInit = 1000;
        varQuantityMax = 1000;
    ...
    {
        scope = 2;
        // model="IAT\Core\Fishing\fish\freshwater\tilapia_xl.p3d";
        itemSize[] = { 3,3 };
        weight = 1500;
        varQuantityInit = 1500;
        varQuantityMax = 1500;
    ...
    class IAT_Fishing_TilapiaFish_Red_Small : IAT_Fishing_TilapiaFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_tilapia_red_co.paa"
        };
    };
    ...
    class IAT_Fishing_TilapiaFish_Green_Small : IAT_Fishing_TilapiaFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_tilapia_green_co.paa"
        };
    };
    ...
    class IAT_Fishing_TilapiaFish_Yellow_Small : IAT_Fishing_TilapiaFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_tilapia_yellow_co.paa"
        };
    };
    ...
    class IAT_Fishing_TilapiaFish_Silver_Small : IAT_Fishing_TilapiaFish_ColorBase
    {
        ...
        hiddenSelectionsTextures[] =
        {
          "IAT\Core\Fishing\fish\freshwater\data\iat_tilapia_silver_co.paa"
        };
    };
