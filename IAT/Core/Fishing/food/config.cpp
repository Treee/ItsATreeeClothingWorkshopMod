...
class CfgVehicles
{
    ...
    class IAT_Fishing_ClamFilletMeat : Edible_Base
    {
        ...
        model = "IAT\Core\Fishing\food\iat_clam_tongue.p3d";
      ...
      "IAT_ClamMeat"
        ...
        {
            "IAT\Core\Fishing\food\data\iat_clam_co.paa",
        ...
        {
            "IAT\Core\Fishing\food\data\iat_clam.rvmat",
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1,{"IAT\Core\Fishing\food\data\iat_clam.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\food\data\iat_clam.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\food\data\iat_clam.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\food\data\iat_clam.rvmat"}},
                        {0,{"IAT\Core\Fishing\food\data\iat_clam.rvmat"}}
                    };
                };
            };
        };
