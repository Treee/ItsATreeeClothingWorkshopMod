class CfgPatches
{
    class IAT_Core_Fishing_Camping
    {
        units[] = {};
        weapons[] = {};
        requiredVersion = 0.1;
...
class CfgVehicles
{
    ...
    class IAT_Fishing_KitBase : Inventory_Base
    {
        ...
        {
            "IAT\Core\Fishing\camping\data\iat_wooden_case_fishing_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
    ...
    class IAT_Fishing_Tacklebox_ColorBase : Inventory_Base
    {
        ...
        model = "IAT\Core\Fishing\camping\iat_tacklebox.p3d";
        itemBehaviour = 1;
        ...
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\camping\data\iat_tacklebox_co.paa"
        };
        class Cargo
        {
            itemsCargoSize[] = { 6,5 };
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.0,{"IAT\Core\Fishing\camping\data\iat_tacklebox.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\camping\data\iat_tacklebox.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\camping\data\iat_tacklebox_damage.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\camping\data\iat_tacklebox_damage.rvmat"}},
                        {0.0,{"IAT\Core\Fishing\camping\data\iat_tacklebox_destruct.rvmat"}}
                    };
                };
            };
        };
    ...
    class IAT_Fishing_Aquarium_ColorBase : Inventory_Base
    {
        ...
        model = "IAT\Core\Fishing\camping\iat_aquarium.p3d";
        itemBehaviour = 0;
        carveNavmesh = 1;
        useEntityHierarchy = "true";
        ...
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\camping\data\iat_aquarium_ca.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.0,{"IAT\Core\Fishing\camping\data\iat_aquarium.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\camping\data\iat_aquarium.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\camping\data\iat_aquarium_damage.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\camping\data\iat_aquarium_damage.rvmat"}},
                        {0.0,{"IAT\Core\Fishing\camping\data\iat_aquarium_destruct.rvmat"}}
                    };
                };
            };
        };
    ...
    class IAT_Fishing_WoodenFishHanger_ColorBase : Inventory_Base
    {
        ...
        model = "IAT\Core\Fishing\camping\iat_woodenfishhanger.p3d";
        itemBehaviour = 0;
        useEntityHierarchy = "true";
        physLayer = "item_large";
        weight = 5000;
        ...
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\camping\data\iat_woodenfishhanger_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.0,{"IAT\Core\Fishing\camping\data\iat_woodenfishhanger.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\camping\data\iat_woodenfishhanger.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\camping\data\iat_woodenfishhanger_damage.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\camping\data\iat_woodenfishhanger_damage.rvmat"}},
                        {0.0,{"IAT\Core\Fishing\camping\data\iat_woodenfishhanger_destruct.rvmat"}}
                    };
                };
            };
        };
    ...
    class IAT_Fishing_WoodenFishRack_ColorBase : Inventory_Base
    {
        ...
        model = "IAT\Core\Fishing\camping\iat_woodenfishrack.p3d";
        itemBehaviour = 0;
        useEntityHierarchy = "true";
        physLayer = "item_large";
        weight = 5000;
        ...
        hiddenSelectionsTextures[] =
        {
            "IAT\Core\Fishing\camping\data\iat_woodenfishrack_co.paa"
        };
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.0,{"IAT\Core\Fishing\camping\data\iat_woodenfishrack.rvmat"}},
                        {0.69999999,{"IAT\Core\Fishing\camping\data\iat_woodenfishrack.rvmat"}},
                        {0.5,{"IAT\Core\Fishing\camping\data\iat_woodenfishrack_damage.rvmat"}},
                        {0.30000001,{"IAT\Core\Fishing\camping\data\iat_woodenfishrack_damage.rvmat"}},
                        {0.0,{"IAT\Core\Fishing\camping\data\iat_woodenfishrack_destruct.rvmat"}}
                    };
                };
            };
        };
