class IAT_Fishing_Construct_CanOfWorms extends RecipeBase
{	
	override void Init()
	{
    ...
    InsertIngredient(1,"Worm");  
		...
		//result1
		AddResult("IAT_Fishing_CanOfWorms_Basic");//add results here
	...
	{
		Debug.Log("IAT_Fishing_Construct_CanOfWorms: Recipe Do method called.","recipes");
	}
};