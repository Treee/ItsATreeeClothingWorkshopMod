class CfgPatches
{
    class IAT_DeleteObjectOnRuined_Structures
    {
        units[] = {};
        weapons[] = {};
        requiredVersion = 0.1;
...
class CfgVehicles
{
    ...
    class IAT_DeleteObjectOnRuined_FrontDoor_Wall : Inventory_Base
    {
        ...
        model = "IAT\Misc\DeleteObjectOnRuined\structures\FrontDoor_wall.p3d";
        class DamageSystem
        {
            class GlobalHealth
            {
    ...
    class IAT_DeleteObjectOnRuined_FrontDoor_Wall_Destroyed : Inventory_Base
    {
        ...
        model = "IAT\Misc\DeleteObjectOnRuined\structures\FrontDoor_wall_dest.p3d";
        carveNavmesh = 1;
        physLayer = "item_large";
        class DamageSystem
        {
