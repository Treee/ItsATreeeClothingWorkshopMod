modded class W_B_Clean// extends RecipeBase
{	
	override void Init()
	{
		m_Name = "#repair";
	...
	{
		PluginSuperRepairIAT module_repairing;
		Class.CastTo(module_repairing, GetPlugin(PluginSuperRepairIAT));
