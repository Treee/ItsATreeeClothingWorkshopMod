class SRP_Recipe_CraftGunpowder_Simple extends RecipeBase
{
	override void Init()
	{
		...
		InsertIngredient(0,"dynamitestick_Mung");//you can insert multiple ingredients this way
...
class SRP_Recipe_CraftGunpowder_Explosives extends RecipeBase
{
	override void Init()
	{
		...
		InsertIngredient(0,"stielhandgranate_Mung");//you can insert multiple ingredients this way
    ...
    // if (chance > 99.5) {
      ...
      // Print("Grenade " + grenade);
      // Print("Landmine " + landmine);
      // if (landmine) {
      //   landmine.SetActive();
      // } else if (grenade) {
      //   grenade.Unpin();
