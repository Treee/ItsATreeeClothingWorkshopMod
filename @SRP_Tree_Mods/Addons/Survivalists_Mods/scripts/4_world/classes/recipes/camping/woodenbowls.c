class Craft_SRP_WoodenBowl extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Carve Wooden Plate";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Bark_ColorBase");//you can insert multiple ingredients this way
    ...
    InsertIngredient(1,"Sickle");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_Bowl_Wood");//add results here
	...
	{
		Debug.Log("Craft_SRP_WoodenBowl: Recipe Do method called","recipes");
	}
};

class Craft_SRP_WoodenBowlDark extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Carve Wooden Plate - Dark";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
    ...
    InsertIngredient(1,"Sickle");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_Bowl_DarkWood");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_WoodenBowlDark: Recipe Do method called","recipes");
	}
};

class Craft_SRP_WoodenBowlCherry extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Carve Wooden Plate - Cherry";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
    ...
    InsertIngredient(1,"Sickle");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_Bowl_CherryWood");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_WoodenBowlCherry: Recipe Do method called","recipes");
	}
};

class Craft_SRP_WoodenBowlSquare extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Carve Wooden Plate - Square";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
    ...
    InsertIngredient(1,"Sickle");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_BowlSquare_Wood");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_WoodenBowlSquare: Recipe Do method called","recipes");
	}
};