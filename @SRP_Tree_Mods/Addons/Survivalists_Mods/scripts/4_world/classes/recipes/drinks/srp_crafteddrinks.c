class Craft_SRP_Blood_Bottle extends RecipeBase
{
	override void Init()
	{
		m_Name = "Fill Bottle";
		...
		m_MaxQuantityIngredient[0] = 0;//-1 = disable check
		...
		//result1
		AddResult("SRP_Blood_Bottle");//add results here
	...
	{
		Debug.Log("Craft_SRP_Blood_Bottle Recipe Do method called","recipes");
	}
};