class Craft_SRP_OMNOGloves_Green extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Repaint";
		...
		//ingredient 2
		InsertIngredient(1,"OMNOGloves_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_OMNOGloves_Green");//add results here
	...
	{
		Debug.Log("Craft_SRP_OMNOGloves_Green: Recipe Do method called","recipes");
	}
};