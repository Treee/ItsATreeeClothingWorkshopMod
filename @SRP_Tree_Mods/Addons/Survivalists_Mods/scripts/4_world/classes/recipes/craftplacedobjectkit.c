...
class Craft_SRP_WoodenShelfSimple_Kit extends RecipeBase
{	
	override void Init()
	{
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_WoodenShelfSimple_Kit Recipe Do method called","recipes");
	}
};

class Craft_SRP_WoodenShelfSimpleGround_Kit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Wooden Shelf Ground Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 6;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
...
class Craft_SRP_GunShelfWall_Kit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gun Shelf Wall Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 6;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GunShelfWall_Kit: Recipe Do method called","recipes");
	}
};

class Craft_SRP_GunShelfGround_Kit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Create Gun Shelf Ground Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 6;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GunShelfGround_Kit: Recipe Do method called","recipes");
	}
};
...
{	
	override void Init()
	{
		m_Name = "Craft Fancy Medium Street Light Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
