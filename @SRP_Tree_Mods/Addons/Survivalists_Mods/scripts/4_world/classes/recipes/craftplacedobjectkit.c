...
class Craft_SRP_SmallDoor_Kit extends RecipeBase
{	
	override void Init()
	{
		...
		//result1
		AddResult("SRP_SmallDoor_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_SmallDoor_Kit: Recipe Do method called","recipes");
	}
};

class Craft_SRP_WideFence_Kit extends RecipeBase
{	
	override void Init()
	{
		//m_Name = "#STR_CraftHandDrillKit0";
		m_Name = "Make Wide Fence Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("SRP_WideFence_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_WideFence_Kit: Recipe Do method called","recipes");
	}
};

class Craft_SRP_WindowBarricade_Kit extends RecipeBase
{	
	override void Init()
	{
		//m_Name = "#STR_CraftHandDrillKit0";
		m_Name = "Window Barrier Kit";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("SRP_WindowBarricade_Kit");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_WindowBarricade_Kit: Recipe Do method called","recipes");
	}
};