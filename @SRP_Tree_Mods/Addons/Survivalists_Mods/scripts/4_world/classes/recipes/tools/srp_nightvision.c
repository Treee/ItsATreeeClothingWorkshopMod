class Craft_SRP_NVBinocular extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Enhance";
		...
		//ingredient 2
		InsertIngredient(1,"NVGoggles");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_NVBinocular");//add results here
	...
	{
		Debug.Log("Craft_SRP_NVBinocular: Recipe Do method called","recipes");
	}
};
