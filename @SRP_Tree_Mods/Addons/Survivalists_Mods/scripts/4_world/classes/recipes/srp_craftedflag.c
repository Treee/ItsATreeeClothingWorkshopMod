class Craft_SRP_WhiteFlag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Craft White Flag";
		...
		//result1
		AddResult("Flag_White");//add results here
	...
	{
		Debug.Log("SRP_Craft_WhiteFlag: Recipe Do method called","recipes");
	}
};
