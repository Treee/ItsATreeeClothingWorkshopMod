modded class ModItemRegisterCallbacks
{
  ...
  override void RegisterHeavy( DayZPlayerType pType, DayzPlayerItemBehaviorCfg pBehavior )
  {
    ...
    pType.AddItemInHandsProfileIK("SRP_Carpentry_RussianHouse_Stairs", "dz/anims/workspaces/player/player_main/player_main_heavy.asi", pBehavior, "dz/anims/anm/player/ik/heavy/wooden_crate.anm"); 
  };
}
