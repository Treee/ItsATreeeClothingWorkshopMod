...
//
//
// You can use this class within PlayerBase like this:
// CameraEffects.changeHue(60);
// The above code will set the hue value to 60 which is the default value that DayZ sets hue to when no effect 
// is being applied. Here is a list of all defaults I know of.
//
// CameraEffects.changeHue(60);
