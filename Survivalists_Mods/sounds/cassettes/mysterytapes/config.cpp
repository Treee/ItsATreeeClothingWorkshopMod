class CfgPatches
{
	class Survivalists_Mods_Sounds_MysteryTapes
	{
		units[]={};
		weapons[]={};
		requiredVersion=1;
...
class CfgSoundShaders
{
  class SRPRadio_Cassette_MysteryTape_SoundShader_Base
	...
	class SRPRadio_MysteryTape_Shader1: SRPRadio_Cassette_MysteryTape_SoundShader_Base
	{
		samples[]=
		{
			{"Survivalists_Mods\sounds\cassettes\mysterytapes\data\William_Jackson_Interview.ogg",1}
		};
	};
	class SRPRadio_MysteryTape2_Shader1: SRPRadio_Cassette_MysteryTape_SoundShader_Base
	{
		samples[]=
		{
      {"Survivalists_Mods\sounds\cassettes\mysterytapes\data\Jennifer_Wells_Interview.ogg",1}
		};
	};
  class SRPRadio_MysteryTape_Mutant_Shader1: SRPRadio_Cassette_MysteryTape_SoundShader_Base
	{
		samples[]=
		{
      {"Survivalists_Mods\sounds\cassettes\mysterytapes\data\A_Mothers_Lullabye.ogg",1}
		};
	};
};
