...
class cfgWeapons
{
	...
	class ttgarand: SKS
	{
		...
		model="Survivalists_Mods\weapons\rifles\ttgarand\ttgarand.p3d";
		attachments[]={"weaponOpticsHunting","StockPouch","weaponWrap"};
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"Survivalists_Mods\weapons\rifles\ttgarand\data\base.rvmat"
							}
						},
