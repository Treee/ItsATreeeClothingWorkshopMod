    ...
    class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1.0,	{	"Survivalists_Mods\characters\glasses\data\eyepatch.rvmat"}},
            {0.69999999,	{	"Survivalists_Mods\characters\glasses\data\eyepatch.rvmat"}},
            {0.5,	{	"Survivalists_Mods\characters\glasses\data\eyepatch_damage.rvmat"}},
            {0.30000001,	{	"Survivalists_Mods\characters\glasses\data\eyepatch_damage.rvmat"}},
            {0.0,	{	"Survivalists_Mods\characters\glasses\data\eyepatch_destruct.rvmat"}}
					};
				};
			};
		};
