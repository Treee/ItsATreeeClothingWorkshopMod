...
//=====================================CRUSHED STONE/ GEMS
  ...
  class SRP_Mining_Crystal_ColorBase: Inventory_Base
	{
		...
		model="Survivalists_Mods\gear\mining\srp_mining_gem_a.p3d";
		animClass="NoFireClass";
    color="base";
		weight=500;
		itemSize[]={1,2};
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_red_ca.paa"
		};
    hiddenSelectionsMaterials[]=
    {
      "Survivalists_Mods\gear\mining\data\srp_mining_gem_a.rvmat"
    };
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1.0,	{"Survivalists_Mods\gear\mining\data\srp_mining_gem_a.rvmat"}},
            {0.69999999,	{"Survivalists_Mods\gear\mining\data\srp_mining_gem_a.rvmat"}},
            {0.5,	{"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_damage.rvmat"}},
            {0.30000001,	{"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_damage.rvmat"}},
            {0.0,	{"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_destruct.rvmat"}}
					};
				};
			};
		};
  ...
  class SRP_Mining_Crystal_A_Blue: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_blue_ca.paa"
		};
  };
  // emerald
  class SRP_Mining_Crystal_A_Green: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_Green_ca.paa"
		};
  };
  // amethyst
  class SRP_Mining_Crystal_A_Purple: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_Purple_ca.paa"
		};
  };
  ...
  class SRP_Mining_Crystal_A_LightBlue: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_lightblue_ca.paa"
		};
  };
  // citrine (orange)
  class SRP_Mining_Crystal_A_Orange: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_orange_ca.paa"
		};
  };
  // diamond (clear)
  class SRP_Mining_Crystal_A_Clear: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_clear_ca.paa"
		};
  };
  // topaz (yellow)
  class SRP_Mining_Crystal_A_Yellow: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_yellow_ca.paa"
		};
  };
  // qurtz (pink)
  class SRP_Mining_Crystal_A_Pink: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_pink_ca.paa"
		};
  };
  // opal (rainbow)
  class SRP_Mining_Crystal_A_Rainbow: SRP_Mining_Crystal_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"Survivalists_Mods\gear\mining\data\srp_mining_gem_a_rainbow_ca.paa"
		};
  };
