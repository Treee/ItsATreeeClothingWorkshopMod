...
class CfgVehicles
{
  ...
  //-------------------------------------- MOD OVERRIDE
    ...
    // -------------------------------- DarthRose
    class SRPRadio_CassetteTape_DarthRose_Constellation : SRPRadio_CassetteTape_Base
    {
        scope = 2;
        displayName = "Constellation";
        descriptionShort = "Music Tape - Credit | Darth Rose | https://open.spotify.com/artist/32yhS1cWxRvWqqmJkpBg84";
        class CfgCassette
        {
            soundSet = "SRPRadio_DarthRose_Constellation_SoundSet1";
        };
    };
    class SRPRadio_CassetteTape_DarthRose_HalfALight : SRPRadio_CassetteTape_Base
    {
        scope = 2;
        displayName = "Half A Light";
        descriptionShort = "Music Tape - Credit | Darth Rose | https://open.spotify.com/artist/32yhS1cWxRvWqqmJkpBg84";
        class CfgCassette
        {
            soundSet = "SRPRadio_DarthRose_HalfALight_SoundSet1";
        };
    };
    class SRPRadio_CassetteTape_DarthRose_TiredEyes : SRPRadio_CassetteTape_Base
    {
        scope = 2;
        displayName = "Tired Eyes";
        descriptionShort = "Music Tape - Credit | Darth Rose | https://open.spotify.com/artist/32yhS1cWxRvWqqmJkpBg84";
        class CfgCassette
        {
            soundSet = "SRPRadio_DarthRose_TiredEyes_SoundSet1";
        };
    };
    // -------------------------------- ProbabLeigh
