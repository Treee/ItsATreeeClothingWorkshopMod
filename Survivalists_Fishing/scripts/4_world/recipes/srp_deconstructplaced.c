class SRP_Fishing_Deconstruct_PlacedObjectKit extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dismantle";
	...
	{
		Debug.Log("SRP_Fishing_Deconstruct_PlacedObjectKit: Recipe Do method called. Type: " +ingredients[1].GetType(),"recipes");
    SRP_Fishing_KitBase.Cast( GetGame().CreateObjectEx(ingredients[1].GetType()+"_Kit", player.GetPosition(), false) );
	}
};
