class Craft_SRP_GoldenCoinsWorn extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Shave Into 10 Worn Gold Coins";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SRP_ForgeIngot_ColorBase");//you can insert multiple ingredients this way
    ...
    InsertIngredient(1,"Sickle");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_Coinage_GoldWorn");//add results here
	...
	{
		Debug.Log("Craft_SRP_GoldenCoinsWorn: Recipe Do method called","recipes");
	}
};
