class Craft_SRP_CrushLargeStone_CrudeTool extends RecipeBase
{	
	override void Init()
	{
...
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SRP_Mining_StoneChunk_ColorBase");//you can insert multiple ingredients this way
...
class Craft_SRP_BagOfStones extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Bag of Stones";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"DryBag_ColorBase");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_MiningCraft_StoneBagStarter");//add results here
    ...
    {
      SRP_MiningCraft_StoneBagStarter item = SRP_MiningCraft_StoneBagStarter.Cast(ingredients[0]);
      if (item)
      {
        return false;
      }
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_BagOfStones: Recipe Do method called","recipes");
	}
};

class Craft_SRP_SmashBagIntoCrushedStones extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Smash Stones";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SRP_MiningCraft_StoneBagStarter");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_MiningCraft_CrushedStoneBag");//add results here
    ...
    if (ingredients[0])
    {
		  SRP_MiningCraft_StoneBagStarter stonebagStarter = SRP_MiningCraft_StoneBagStarter.Cast( ingredients[0] );
      canCraft = (stonebagStarter && stonebagStarter.GetInventory().CountInventory() > 4);
    }
		return canCraft;
	}
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_SmashBagIntoCrushedStones: Recipe Do method called","recipes");
	}
};

class Craft_SRP_CrucibleEmptyLime extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Begin Crucible";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("SRP_MetalBucket_Lime");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_CrucibleEmptyLime: Recipe Do method called","recipes");
	}
};

class Craft_SRP_CrucibleEmptyMortar extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Harden Crucible";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
		...
		//ingredient 2
		InsertIngredient(1,"SRP_MetalBucket_Lime");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("SRP_MetalBucket_Mortar");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_CrucibleEmptyMortar: Recipe Do method called","recipes");
	}
};
...
{	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"SRP_MiningCraft_CrushedStoneBag");//you can insert multiple ingredients this way
