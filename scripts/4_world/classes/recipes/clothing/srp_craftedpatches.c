class Craft_SRP_Patch_Russian extends RecipeBase
{	
	override void Init()
	{
		m_Name = "ID Patch - RU";
		...
		AddResult("MVS_CountryFlag_Russia");//single result
	...
	{
		Debug.Log("Craft_SRP_Patch_Russian: Recipe Do method called","recipes");
	}
};
