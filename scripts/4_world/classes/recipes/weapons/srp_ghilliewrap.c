...
class Craft_SRP_GhillieWrapWoodland extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Gun Wrap";
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieWrapWoodland: Recipe Do method called","recipes");
	}
};

class Craft_SRP_GhillieWrapMossy extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Gun Wrap";
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieWrapMossy: Recipe Do method called","recipes");
	}
};

class Craft_SRP_GhillieWrapWinter extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Gun Wrap";
		...
		//result1
		AddResult("GhillieAtt_Winter");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieWrapWinter: Recipe Do method called","recipes");
	}
};

class Craft_SRP_GhillieWrapBlack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Gun Wrap";
		...
		//result1
		AddResult("GhillieAtt_Black");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieWrapBlack: Recipe Do method called","recipes");
	}
};

class Craft_SRP_GhillieBushragBlack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Recolor Black";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
		...
		//ingredient 2
		InsertIngredient(1,"Spraycan_Black");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("GhillieBushrag_Black");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieBushragBlack: Recipe Do method called","recipes");
	}
};
class Craft_SRP_GhillieBushragWinter extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Recolor White";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = 0.02;// value > 0 for roughness, value < 0 for precision
		...
		//ingredient 2
		InsertIngredient(1,"Spraycan_Winter");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("GhillieBushrag_Winter");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieBushragWinter: Recipe Do method called","recipes");
	}
};

class Craft_SRP_GhillieTopBlack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Recolor Black";
		...
		//result1
		AddResult("GhillieTop_Black");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieTopBlack: Recipe Do method called","recipes");
	}
};
class Craft_SRP_GhillieTopWinter extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Recolor White";
		...
		//result1
		AddResult("GhillieTop_Winter");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieTopWinter: Recipe Do method called","recipes");
	}
};

class Craft_SRP_GhillieSuitBlack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Recolor Black";
		...
		//result1
		AddResult("GhillieSuit_Black");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieSuitBlack: Recipe Do method called","recipes");
	}
};
class Craft_SRP_GhillieSuitWinter extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Recolor White";
		...
		//result1
		AddResult("GhillieSuit_Winter");//add results here
	...
	override void Do(ItemBase ingredients[], PlayerBase player,array<ItemBase> results, float specialty_weight)//gets called upon recipe's completion
	{
		Debug.Log("Craft_SRP_GhillieSuitWinter: Recipe Do method called","recipes");
	}
};