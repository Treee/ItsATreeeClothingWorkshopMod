...
class CfgVehicles
{
    ...
    class SRP_Tool_CoalRake : Inventory_Base
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_coalrake.p3d";
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1,{"SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs.rvmat"}},
                        {0.69999999,{"SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs.rvmat"}},
                        {0.5,{"SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_damage.rvmat"}},
                        {0.30000001,{"SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_damage.rvmat"}},
                        {0,{"SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_destruct.rvmat"}}
                    };
                };
            };
        };
    ...
    class SRP_ToolRack_Hammers : Inventory_Base
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_toolrack_hammer.p3d";
        attachments[] =
        {
            "Hammer1",
            "Hammer2",
    ...
    class SRP_MiningTool_HammerBase : Inventory_Base
    {
        ...
        hiddenSelectionsTextures[] = { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_stone_co.paa" };
        class DamageSystem
        {
            class GlobalHealth
            {
    ...
    class SRP_MiningTool_StoneHammerLarge : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_hammerlarge.p3d";
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.0, { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs.rvmat"}},
                        {0.69999999, { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs.rvmat"}},
                        {0.5, { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_damage.rvmat"}},
                        {0.30000001, { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_damage.rvmat"}},
                        {0.0, { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_destruct.rvmat"}}
                    };
                };
            };
        };
    ...
    class SRP_MiningTool_StoneHammerMedium : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_hammermedium.p3d";
        class DamageSystem
        {
            class GlobalHealth
            {
    ...
    class SRP_MiningTool_StoneHammerSmall : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_hammersmall.p3d";
        class DamageSystem
        {
            class GlobalHealth
            {
    ...
    class SRP_MiningTool_StoneHammerSteelPunch : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_hammersteelpunch.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_stone_co.paa" };
        class DamageSystem
        {
    ...
    class SRP_MiningTool_StoneHammerFlattener : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_hammerflattener.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_stone_co.paa" };
        class DamageSystem
        {
    ...
    class SRP_MiningTool_IronHammerLarge : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_hammerlarge.p3d";
        hiddenSelections[] = { "zbytek" };
        hiddenSelectionsTextures[] = { "SRP\Metallurgy\gear\tools\data\srp_toolrack_tongs_metal_co.paa" };
        class DamageSystem
        {
            class GlobalHealth
            {
    ...
    class SRP_MiningTool_IronTongsSmall : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_tongs2.p3d";
        attachments[] =
        {
          "SRP_Crucible",
          "SRP_IngotMold",
    ...
    class SRP_MiningTool_IronTongsMedium : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_tongs.p3d";
        attachments[] =
        {
          "SRP_Crucible",
          "SRP_IngotMold",
    ...
    class SRP_MiningTool_IronTongsLarge : SRP_MiningTool_HammerBase
    {
        ...
        model = "SRP\Metallurgy\gear\tools\srp_miningtool_tongs3.p3d";
        attachments[] =
        {
          "SRP_Crucible",
          "SRP_IngotMold",
