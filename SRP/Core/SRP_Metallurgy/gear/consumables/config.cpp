...
//===================================== BUCKETS
  class SRP_MetalBucket_ColorBase: Inventory_Base
  {
    ...
    displayName="Bucket";
		...
		model="SRP\Core\SRP_Metallurgy\gear\consumables\srp_bucket.p3d";
		weight=250;
		itemSize[]={3,3};
    absorbency=0;
    varWetMax=0;
    ...
    {
      "SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket_co.paa"
    };
    class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1.0,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket.rvmat"}},
            {0.69999999,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket.rvmat"}},
            {0.5,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket_damage.rvmat"}},
            {0.30000001,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket_damage.rvmat"}},
            {0.0,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket_destruct.rvmat"}}
					};
				};
			};
		};
  ...
  class SRP_MetalBucket_Lime: SRP_MetalBucket_ColorBase
    ...
    hiddenSelectionsTextures[]=
    {
      "SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket_lime_co.paa"
    };
	};
  class SRP_MetalBucket_Mortar: SRP_MetalBucket_ColorBase
    ...
    hiddenSelectionsTextures[]=
    {
      "SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket_mortar_co.paa"
    };
	};
...
//===================================== CRUCIBLES
  class SRP_ForgeCrucible_ColorBase: Inventory_Base
	{
		...
		model="SRP\Core\SRP_Metallurgy\gear\consumables\srp_forge_crucible.p3d";
		weight=440;
		itemSize[]={4,3};
    color="base";
    inventorySlot[]=
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1.0,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible.rvmat"}},
            {0.69999999,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible.rvmat"}},
            {0.5,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_damage.rvmat"}},
            {0.30000001,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_damage.rvmat"}},
            {0.0,	{	"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_destruct.rvmat"}}
					};
				};
			};
		};
  ...
  class SRP_ForgeCrucible_Empty: SRP_ForgeCrucible_ColorBase
	{
		scope=2;
    model="SRP\Core\SRP_Metallurgy\gear\consumables\srp_forge_crucible_empty.p3d";
    ...
    hiddenSelectionsTextures[]={
      "SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_bucket_crucible_co.paa"
    };
	};
  class SRP_ForgeCrucible_Copper: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_copper_co.paa"
		};
	};
  class SRP_ForgeCrucible_Tin: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_tin_co.paa"
		};
	};
  class SRP_ForgeCrucible_Bronze: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_bronze_co.paa"
		};
	};
  class SRP_ForgeCrucible_Iron: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_iron_co.paa"
		};
	};
  class SRP_ForgeCrucible_Gold: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_gold_co.paa"
		};
	};
  class SRP_ForgeCrucible_Platinum: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_platinum_co.paa"
		};
	};
  class SRP_ForgeCrucible_Silver: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_silver_co.paa"
		};
	};
  class SRP_ForgeCrucible_Zinc: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_zinc_co.paa"
		};
	};
  class SRP_ForgeCrucible_Brass: SRP_ForgeCrucible_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_brass_co.paa"
		};
	};
...
//===================================== INGOT MOLDS
  class SRP_ForgeIngotMold_ColorBase: Inventory_Base
  {
		...
		model="SRP\Core\SRP_Metallurgy\gear\consumables\srp_forge_ingotmold.p3d";
  ...
  class SRP_ForgeIngotMold_MetalEmpty: SRP_ForgeIngotMold_ColorBase
    ...
    model="SRP\Core\SRP_Metallurgy\gear\consumables\srp_forge_ingotmold_empty.p3d";
    color="metalempty";
    hiddenSelections[]=
		{
			"zbytek"
  ...
  class SRP_ForgeIngotMold_Empty: SRP_ForgeIngotMold_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_crucible_empty_co.paa"
		};
	};
...
//===================================== INGOTS
  class SRP_ForgeIngot_ColorBase: Inventory_Base
  {
		...
		model="SRP\Core\SRP_Metallurgy\gear\consumables\srp_forge_ingot.p3d";
		animClass="NoFireClass";
    physLayer="item_small";
    color="base";
		weight=500;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1.0,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot.rvmat"}},
            {0.69999999,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot.rvmat"}},
            {0.5,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_damage.rvmat"}},
            {0.30000001,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_damage.rvmat"}},
            {0.0,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_destruct.rvmat"}}
					};
				};
			};
		};
  ...
  class SRP_ForgeIngot_Copper: SRP_ForgeIngot_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_copper_co.paa"
		};
	};
  class SRP_ForgeIngot_Tin: SRP_ForgeIngot_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_tin_co.paa"
		};
	};
  ...
  class SRP_ForgeIngot_Iron: SRP_ForgeIngot_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_iron_co.paa"
		};
	};
  class SRP_ForgeIngot_Gold: SRP_ForgeIngot_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_gold_co.paa"
		};
	};
  class SRP_ForgeIngot_Platinum: SRP_ForgeIngot_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_platinum_co.paa"
		};
	};
  ...
  class SRP_ForgeIngot_Silver: SRP_ForgeIngot_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_silver_co.paa"
		};
	};
  class SRP_ForgeIngot_Zinc: SRP_ForgeIngot_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_zinc_co.paa"
		};
	};
  class SRP_ForgeIngot_Brass: SRP_ForgeIngot_ColorBase
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_forge_ingot_brass_co.paa"
		};
	};
...
//===================================== PLATES
  class SRP_ForgeIngotPlate_ColorBase: Inventory_Base
  {
		...
		model="SRP\Core\SRP_Metallurgy\gear\consumables\srp_forge_ingotplate.p3d";
		animClass="NoFireClass";
    physLayer="item_small";
    color="base";
		weight=500;
...
//===================================== RODS
  class SRP_ForgeIngotRod_ColorBase: Inventory_Base
  {
		...
		model="SRP\Core\SRP_Metallurgy\gear\consumables\srp_forge_ingotrod.p3d";
		animClass="NoFireClass";
    physLayer="item_small";
    color="base";
		weight=500;
...
//===================================== COINS
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[]=
					{
						{1.0,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_coinage.rvmat"}},
            {0.69999999,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_coinage.rvmat"}},
            {0.5,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_coinage_damage.rvmat"}},
            {0.30000001,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_coinage_damage.rvmat"}},
            {0.0,	{"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_coinage_destruct.rvmat"}}
					};
				};
			};
		};
  ...
  class SRP_Coinage_Blank1_Default: SRP_Coinage_Blank1_ColorBase
  {
    ...
    hiddenSelections[]=
		...
		hiddenSelectionsTextures[]=
		{
			"SRP\Core\SRP_Metallurgy\gear\consumables\data\srp_coinage_co.paa"
		};
  };
