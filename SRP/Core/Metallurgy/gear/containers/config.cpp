...
class CfgVehicles
{
    ...
    class SRP_MasonryMetallurgy_KitBase : Inventory_Base
    {
        ...
        hiddenSelectionsTextures[] = { "SRP\Core\Metallurgy\gear\containers\data\srp_woodencase_kit_co.paa" };
        class DamageSystem
        {
            class GlobalHealth
            {
    ...
    class SRP_StoneForgeWorkbench : FireplaceBase
    {
        ...
        model = "SRP\Core\Metallurgy\gear\containers\srp_forge_stonebasic.p3d";
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.01,{"SRP\Core\Metallurgy\gear\containers\data\srp_stoneforge.rvmat"}},
                        {0.69999999,{"SRP\Core\Metallurgy\gear\containers\data\srp_stoneforge.rvmat"}},
                        {0.5,{"SRP\Core\Metallurgy\gear\containers\data\srp_stoneforge.rvmat"}},
                        {0.30000001,{"SRP\Core\Metallurgy\gear\containers\data\srp_stoneforge.rvmat"}},
                        {0.0099999998,{"SRP\Core\Metallurgy\gear\containers\data\srp_stoneforge.rvmat"}}
                    };
                };
            };
        };
    ...
    class SRP_AdvancedStoneForgeWorkbench : FireplaceBase
    {
        ...
        model = "SRP\Core\Metallurgy\gear\containers\srp_forge_stoneadvanced.p3d";
        useEntityHierarchy = "true";
        destroyOnEmpty = 0;
        carveNavmesh = 0;
        canBeDigged = 0;
        ...
        class DamageSystem
        {
            class GlobalHealth
            {
                class Health
                {
                    ...
                    healthLevels[] =
                    {
                        {1.01,{"SRP\Core\Metallurgy\gear\containers\data\srp_forgeandbellows.rvmat"}},
                        {0.69999999,{"SRP\Core\Metallurgy\gear\containers\data\srp_forgeandbellows.rvmat"}},
                        {0.5,{"SRP\Core\Metallurgy\gear\containers\data\srp_forgeandbellows.rvmat"}},
                        {0.30000001,{"SRP\Core\Metallurgy\gear\containers\data\srp_forgeandbellows.rvmat"}},
                        {0.0099999998,{"SRP\Core\Metallurgy\gear\containers\data\srp_forgeandbellows.rvmat"}}
                    };
                };
            };
        };
    ...
    class SRP_AdvancedStoneForgeWorkbench_Bellows : Inventory_Base
    {
        ...
        model = "SRP\Core\Metallurgy\gear\containers\srp_forge_stoneadvancedbellows.p3d";
