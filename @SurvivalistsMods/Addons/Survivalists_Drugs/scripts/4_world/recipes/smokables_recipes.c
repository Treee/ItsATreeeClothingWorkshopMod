...
{	
	override void Init()
	{
		...
		InsertIngredient(0,"cigarette_mung");//you can insert multiple ingredients this way    
...
class SRP_Add_JointToPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add Joint";
		...
		InsertIngredient(0,"SRP_DrugPack_ZWeed");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SRP_Smokable_ZWeed");//you can insert multiple ingredients this way
...
class SRP_Add_CigaretteToPack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Add Cigarette";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 1;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"SRP_DrugPack_Cigarette");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1,"SRP_Smokable_Cigarette");//you can insert multiple ingredients this way
		InsertIngredient(1,"cigarette_mung");//you can insert multiple ingredients this way
...
{	
	override void Init()
	{
		...
		InsertIngredient(0,"SRP_DrugPack_ColorBase");//you can insert multiple ingredients this way
